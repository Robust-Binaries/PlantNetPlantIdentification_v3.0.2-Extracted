...
import android.support.p000v4.view.accessibility.AccessibilityManagerCompat.TouchExplorationStateChangeListener;
...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
    ...
    private static final int[] SNACKBAR_STYLE_ATTR = {C0043R.attr.snackbarStyle};
    ...
    protected static class SnackbarBaseLayout extends FrameLayout {
        ...
        protected SnackbarBaseLayout(Context context, AttributeSet attributeSet) {
            ...
            if (obtainStyledAttributes.hasValue(C0043R.styleable.SnackbarLayout_elevation)) {
                ViewCompat.setElevation(this, (float) obtainStyledAttributes.getDimensionPixelSize(C0043R.styleable.SnackbarLayout_elevation, 0));
            }
    ...
    public int getSnackbarBaseLayoutResId() {
        return hasSnackbarStyleAttr() ? C0043R.layout.mtrl_layout_snackbar : C0043R.layout.design_layout_snackbar;
    }
