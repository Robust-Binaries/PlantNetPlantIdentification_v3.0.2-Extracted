...
public class BottomNavigationItemView extends FrameLayout implements ItemView {
    ...
    public BottomNavigationItemView(Context context, AttributeSet attributeSet, int i) {
        ...
        LayoutInflater.from(context).inflate(C0043R.layout.design_bottom_navigation_item, this, true);
        setBackgroundResource(C0043R.C0046drawable.design_bottom_navigation_item_background);
        this.defaultMargin = resources.getDimensionPixelSize(C0043R.dimen.design_bottom_navigation_margin);
        this.icon = (ImageView) findViewById(C0043R.C0047id.icon);
        this.smallLabel = (TextView) findViewById(C0043R.C0047id.smallLabel);
        this.largeLabel = (TextView) findViewById(C0043R.C0047id.largeLabel);
