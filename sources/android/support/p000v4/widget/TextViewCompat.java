...
public final class TextViewCompat {
    ...
    public static void setFirstBaselineToTopHeight(@NonNull TextView textView, @C0017Px @IntRange(from = 0) int i) {
        int i2;
    ...
    public static void setLastBaselineToBottomHeight(@NonNull TextView textView, @C0017Px @IntRange(from = 0) int i) {
        int i2;
        Preconditions.checkArgumentNonnegative(i);
        FontMetricsInt fontMetricsInt = textView.getPaint().getFontMetricsInt();
        if (VERSION.SDK_INT < 16 || textView.getIncludeFontPadding()) {
    ...
    public static void setLineHeight(@NonNull TextView textView, @C0017Px @IntRange(from = 0) int i) {
        Preconditions.checkArgumentNonnegative(i);
