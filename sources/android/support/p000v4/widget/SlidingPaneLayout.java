...
public class SlidingPaneLayout extends ViewGroup {
    ...
    public void setParallaxDistance(@C0017Px int i) {
        this.mParallaxBy = i;
        requestLayout();
    }
    ...
    public boolean canScroll(android.view.View r13, boolean r14, int r15, int r16, int r17) {
        ...
        L_0x0066:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p000v4.widget.SlidingPaneLayout.canScroll(android.view.View, boolean, int, int, int):boolean");
    }
