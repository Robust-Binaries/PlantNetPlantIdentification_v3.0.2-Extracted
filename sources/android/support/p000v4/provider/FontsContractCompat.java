...
public class FontsContractCompat {
    ...
    public static class FontInfo {
        ...
        @RestrictTo({Scope.LIBRARY_GROUP})
        public FontInfo(@NonNull Uri uri, @IntRange(from = 0) int i, @IntRange(from = 1, mo116to = 1000) int i2, boolean z, int i3) {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:38:0x008c, code lost:
        sBackgroundThread.postAndReply(r1, new android.support.p000v4.provider.FontsContractCompat.C03273());
     */
    ...
    static FontInfo[] getFontFromProvider(Context context, FontRequest fontRequest, String str, CancellationSignal cancellationSignal) {
        ...
        Uri build2 = new Builder().scheme("content").authority(str2).appendPath(UriUtil.LOCAL_FILE_SCHEME).build();
        Cursor cursor2 = null;
        try {
