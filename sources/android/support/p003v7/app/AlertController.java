...
class AlertController {
    ...
    public static class AlertParams {
        ...
        /* JADX WARNING: type inference failed for: r9v2, types: [android.support.v7.app.AlertController$CheckedItemAdapter] */
        /* JADX WARNING: type inference failed for: r2v3, types: [android.widget.SimpleCursorAdapter] */
        /* JADX WARNING: type inference failed for: r1v16, types: [android.support.v7.app.AlertController$AlertParams$2] */
        /* JADX WARNING: type inference failed for: r1v17, types: [android.support.v7.app.AlertController$AlertParams$1] */
        ...
        /* JADX WARNING: Multi-variable type inference failed. Error: jadx.core.utils.exceptions.JadxRuntimeException: No candidate types for var: r9v1, types: [android.widget.ListAdapter]
          assigns: [android.widget.ListAdapter, android.widget.SimpleCursorAdapter, android.support.v7.app.AlertController$AlertParams$2, android.support.v7.app.AlertController$AlertParams$1]
          uses: [?[int, boolean, OBJECT, ARRAY, byte, short, char], android.widget.ListAdapter, android.widget.SimpleCursorAdapter, android.support.v7.app.AlertController$AlertParams$2, android.support.v7.app.AlertController$AlertParams$1]
          mth insns count: 69
    ...
    public static class RecycleListView extends ListView {
        ...
        public RecycleListView(Context context, AttributeSet attributeSet) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0408R.styleable.RecycleListView);
            this.mPaddingBottomNoButtons = obtainStyledAttributes.getDimensionPixelOffset(C0408R.styleable.RecycleListView_paddingBottomNoButtons, -1);
            this.mPaddingTopNoTitle = obtainStyledAttributes.getDimensionPixelOffset(C0408R.styleable.RecycleListView_paddingTopNoTitle, -1);
        }
    ...
    private static boolean shouldCenterSingleButton(Context context) {
        ...
        context.getTheme().resolveAttribute(C0408R.attr.alertDialogCenterButtons, typedValue, true);
    ...
    public AlertController(Context context, AppCompatDialog appCompatDialog, Window window) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(null, C0408R.styleable.AlertDialog, C0408R.attr.alertDialogStyle, 0);
        this.mAlertDialogLayout = obtainStyledAttributes.getResourceId(C0408R.styleable.AlertDialog_android_layout, 0);
        this.mButtonPanelSideLayout = obtainStyledAttributes.getResourceId(C0408R.styleable.AlertDialog_buttonPanelSideLayout, 0);
        this.mListLayout = obtainStyledAttributes.getResourceId(C0408R.styleable.AlertDialog_listLayout, 0);
        this.mMultiChoiceItemLayout = obtainStyledAttributes.getResourceId(C0408R.styleable.AlertDialog_multiChoiceItemLayout, 0);
        this.mSingleChoiceItemLayout = obtainStyledAttributes.getResourceId(C0408R.styleable.AlertDialog_singleChoiceItemLayout, 0);
        this.mListItemLayout = obtainStyledAttributes.getResourceId(C0408R.styleable.AlertDialog_listItemLayout, 0);
        this.mShowTitle = obtainStyledAttributes.getBoolean(C0408R.styleable.AlertDialog_showTitle, true);
        this.mButtonIconDimen = obtainStyledAttributes.getDimensionPixelSize(C0408R.styleable.AlertDialog_buttonIconDimen, 0);
    ...
    private void setupView() {
        View findViewById = this.mWindow.findViewById(C0408R.C0411id.parentPanel);
        View findViewById2 = findViewById.findViewById(C0408R.C0411id.topPanel);
        View findViewById3 = findViewById.findViewById(C0408R.C0411id.contentPanel);
        View findViewById4 = findViewById.findViewById(C0408R.C0411id.buttonPanel);
        ViewGroup viewGroup = (ViewGroup) findViewById.findViewById(C0408R.C0411id.customPanel);
        setupCustomContent(viewGroup);
        View findViewById5 = viewGroup.findViewById(C0408R.C0411id.topPanel);
        View findViewById6 = viewGroup.findViewById(C0408R.C0411id.contentPanel);
        View findViewById7 = viewGroup.findViewById(C0408R.C0411id.buttonPanel);
        ...
        if (!z3 && resolvePanel2 != null) {
            View findViewById8 = resolvePanel2.findViewById(C0408R.C0411id.textSpacerNoButtons);
        ...
        if (z2) {
            ...
            if (!(this.mMessage == null && this.mListView == null)) {
                view = resolvePanel.findViewById(C0408R.C0411id.titleDividerNoCustom);
            }
            if (view != null) {
                view.setVisibility(0);
            }
        } else if (resolvePanel2 != null) {
            View findViewById9 = resolvePanel2.findViewById(C0408R.C0411id.textSpacerNoTitle);
    ...
    private void setScrollIndicators(ViewGroup viewGroup, View view, int i, int i2) {
        final View findViewById = this.mWindow.findViewById(C0408R.C0411id.scrollIndicatorUp);
        View findViewById2 = this.mWindow.findViewById(C0408R.C0411id.scrollIndicatorDown);
    ...
    private void setupCustomContent(ViewGroup viewGroup) {
        ...
        if (z) {
            FrameLayout frameLayout = (FrameLayout) this.mWindow.findViewById(C0408R.C0411id.custom);
    ...
    private void setupTitle(ViewGroup viewGroup) {
        if (this.mCustomTitleView != null) {
            ...
            this.mWindow.findViewById(C0408R.C0411id.title_template).setVisibility(8);
            return;
        }
        ...
        this.mTitleView = (TextView) this.mWindow.findViewById(C0408R.C0411id.alertTitle);
    ...
    private void setupContent(ViewGroup viewGroup) {
        this.mScrollView = (NestedScrollView) this.mWindow.findViewById(C0408R.C0411id.scrollView);
