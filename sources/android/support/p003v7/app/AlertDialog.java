...
public class AlertDialog extends AppCompatDialog implements DialogInterface {
    ...
    public static class Builder {
        ...
        public Builder setTitle(@StringRes int i) {
            AlertParams alertParams = this.f20P;
        ...
        public Builder setIconAttribute(@AttrRes int i) {
            ...
            this.f20P.mContext.getTheme().resolveAttribute(i, typedValue, true);
            this.f20P.mIconId = typedValue.resourceId;
            return this;
        }
        ...
        public Builder setPositiveButtonIcon(Drawable drawable) {
            this.f20P.mPositiveButtonIcon = drawable;
            return this;
        }
        ...
        public Builder setNegativeButtonIcon(Drawable drawable) {
            this.f20P.mNegativeButtonIcon = drawable;
            return this;
        }
        ...
        public Builder setNeutralButton(@StringRes int i, OnClickListener onClickListener) {
            ...
            this.f20P.mNeutralButtonListener = onClickListener;
            return this;
        }
        ...
        public Builder setNeutralButtonIcon(Drawable drawable) {
            this.f20P.mNeutralButtonIcon = drawable;
            return this;
        }
        ...
        public Builder setMultiChoiceItems(@ArrayRes int i, boolean[] zArr, OnMultiChoiceClickListener onMultiChoiceClickListener) {
            AlertParams alertParams = this.f20P;
            alertParams.mItems = alertParams.mContext.getResources().getTextArray(i);
            AlertParams alertParams2 = this.f20P;
        ...
        public Builder setOnItemSelectedListener(OnItemSelectedListener onItemSelectedListener) {
            this.f20P.mOnItemSelectedListener = onItemSelectedListener;
            return this;
        }
        ...
        public Builder setInverseBackgroundForced(boolean z) {
            this.f20P.mForceInverseBackground = z;
            return this;
        }

        @RestrictTo({Scope.LIBRARY_GROUP})
        public Builder setRecycleOnMeasureEnabled(boolean z) {
            this.f20P.mRecycleOnMeasure = z;
            return this;
        }
    ...
    static int resolveDialogTheme(@NonNull Context context, @StyleRes int i) {
        ...
        TypedValue typedValue = new TypedValue();
        context.getTheme().resolveAttribute(C0408R.attr.alertDialogTheme, typedValue, true);
