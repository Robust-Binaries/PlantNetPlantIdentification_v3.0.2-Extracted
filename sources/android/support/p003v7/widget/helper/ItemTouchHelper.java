...
public class ItemTouchHelper extends ItemDecoration implements OnChildAttachStateChangeListener {
    ...
    /* renamed from: UP */
    public static final int f34UP = 1;
            ...
            if (actionMasked == 0) {
                ...
                if (ItemTouchHelper.this.mSelected == null) {
                    ...
                    if (findAnimation != null) {
                        ItemTouchHelper.this.mInitialTouchX -= findAnimation.f35mX;
                        ItemTouchHelper.this.mInitialTouchY -= findAnimation.f36mY;
    ...
    public static abstract class Callback {
        ...
        public android.support.p003v7.widget.RecyclerView.ViewHolder chooseDropTarget(@android.support.annotation.NonNull android.support.p003v7.widget.RecyclerView.ViewHolder r15, @android.support.annotation.NonNull java.util.List<android.support.p003v7.widget.RecyclerView.ViewHolder> r16, int r17, int r18) {
            /*
                r14 = this;
                r0 = r15
            ...
            L_0x0028:
                ...
                android.support.v7.widget.RecyclerView$ViewHolder r10 = (android.support.p003v7.widget.RecyclerView.ViewHolder) r10
            ...
            L_0x00be:
                return r6
            */
            throw new UnsupportedOperationException("Method not decompiled: android.support.p003v7.widget.helper.ItemTouchHelper.Callback.chooseDropTarget(android.support.v7.widget.RecyclerView$ViewHolder, java.util.List, int, int):android.support.v7.widget.RecyclerView$ViewHolder");
        }
        ...
        private int getMaxDragScroll(RecyclerView recyclerView) {
            if (this.mCachedMaxScrollSpeed == -1) {
                this.mCachedMaxScrollSpeed = recyclerView.getResources().getDimensionPixelSize(C0416R.dimen.item_touch_helper_max_drag_scroll_per_frame);
            }
        ...
        public void onDraw(Canvas canvas, RecyclerView recyclerView, ViewHolder viewHolder, List<RecoverAnimation> list, int i, float f, float f2) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                ...
                onChildDraw(canvas, recyclerView, recoverAnimation.mViewHolder, recoverAnimation.f35mX, recoverAnimation.f36mY, recoverAnimation.mActionState, false);
        ...
        public void onDrawOver(Canvas canvas, RecyclerView recyclerView, ViewHolder viewHolder, List<RecoverAnimation> list, int i, float f, float f2) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                ...
                int save = canvas.save();
                onChildDrawOver(canvas, recyclerView, recoverAnimation.mViewHolder, recoverAnimation.f35mX, recoverAnimation.f36mY, recoverAnimation.mActionState, false);
                canvas.restoreToCount(save);
            }
            if (viewHolder != null) {
                int save2 = canvas.save();
    ...
    private static class RecoverAnimation implements AnimatorListener {
        ...
        public void update() {
            ...
            if (f == f2) {
                this.f35mX = this.mViewHolder.itemView.getTranslationX();
            } else {
                this.f35mX = f + (this.mFraction * (f2 - f));
            }
            float f3 = this.mStartDy;
            float f4 = this.mTargetY;
            if (f3 == f4) {
                this.f36mY = this.mViewHolder.itemView.getTranslationY();
            } else {
                this.f36mY = f3 + (this.mFraction * (f4 - f3));
            }
        }
    ...
    public void attachToRecyclerView(@Nullable RecyclerView recyclerView) {
        ...
        if (recyclerView2 != recyclerView) {
            ...
            if (recyclerView != null) {
                ...
                this.mSwipeEscapeVelocity = resources.getDimension(C0416R.dimen.item_touch_helper_swipe_escape_velocity);
                this.mMaxSwipeVelocity = resources.getDimension(C0416R.dimen.item_touch_helper_swipe_escape_max_velocity);
                setupCallbacks();
            }
        }
    }
        ...
        if (viewHolder2 != this.mSelected || i3 != this.mActionState) {
            ...
            if (viewHolder3 != null) {
                if (viewHolder3.itemView.getParent() != null) {
                    ...
                    C05223 r0 = new RecoverAnimation(this, viewHolder3, i6, i4, f3, f4, f2, f) {
    ...
    public View findChildView(MotionEvent motionEvent) {
        ...
        for (int size = this.mRecoverAnimations.size() - 1; size >= 0; size--) {
            ...
            if (hitTest(view2, x, y, recoverAnimation.f35mX, recoverAnimation.f36mY)) {
                return view2;
            }
        }
