...
import android.support.p003v7.recyclerview.C0416R;
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2 {
    ...
    public static abstract class LayoutManager {
        ...
        public void offsetChildrenHorizontal(@C0017Px int i) {
            RecyclerView recyclerView = this.mRecyclerView;
            if (recyclerView != null) {
        ...
        public void offsetChildrenVertical(@C0017Px int i) {
            RecyclerView recyclerView = this.mRecyclerView;
            if (recyclerView != null) {
        ...
        public static Properties getProperties(@NonNull Context context, @Nullable AttributeSet attributeSet, int i, int i2) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0416R.styleable.RecyclerView, i, i2);
            properties.orientation = obtainStyledAttributes.getInt(C0416R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = obtainStyledAttributes.getInt(C0416R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = obtainStyledAttributes.getBoolean(C0416R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = obtainStyledAttributes.getBoolean(C0416R.styleable.RecyclerView_stackFromEnd, false);
    ...
    public final class Recycler {
        ...
        public android.support.p003v7.widget.RecyclerView.ViewHolder tryGetViewHolderForPositionByDeadline(int r17, boolean r18, long r19) {
            ...
            L_0x0121:
                ...
                boolean r5 = android.support.p003v7.widget.RecyclerView.ALLOW_THREAD_GAP_WORK
                if (r5 == 0) goto L_0x013e
                android.view.View r5 = r2.itemView
                android.support.v7.widget.RecyclerView r5 = android.support.p003v7.widget.RecyclerView.findNestedRecyclerView(r5)
                if (r5 == 0) goto L_0x013e
            ...
            L_0x018f:
                ...
                if (r0 == 0) goto L_0x01c9
                int r0 = android.support.p003v7.widget.RecyclerView.ItemAnimator.buildAdapterChangeFlagsForAnimations(r10)
    ...
    public static abstract class SmoothScroller {
        ...
        public static class Action {
            ...
            public Action(@C0017Px int i, @C0017Px int i2) {
                this(i, i2, Integer.MIN_VALUE, null);
            }

            public Action(@C0017Px int i, @C0017Px int i2, int i3) {
                this(i, i2, i3, null);
            }

            public Action(@C0017Px int i, @C0017Px int i2, int i3, @Nullable Interpolator interpolator) {
            ...
            public void setDx(@C0017Px int i) {
                this.mChanged = true;
                this.mDx = i;
            }
            ...
            public void setDy(@C0017Px int i) {
                this.mChanged = true;
                this.mDy = i;
            }
            ...
            public void update(@C0017Px int i, @C0017Px int i2, int i3, @Nullable Interpolator interpolator) {
                this.mDx = i;
                this.mDy = i2;
                this.mDuration = i3;
                this.mInterpolator = interpolator;
    ...
    public void onScrolled(@C0017Px int i, @C0017Px int i2) {
    }
    ...
    public RecyclerView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        if (attributeSet != null) {
            TypedArray obtainStyledAttributes2 = context.obtainStyledAttributes(attributeSet, C0416R.styleable.RecyclerView, i, 0);
            String string = obtainStyledAttributes2.getString(C0416R.styleable.RecyclerView_layoutManager);
            if (obtainStyledAttributes2.getInt(C0416R.styleable.RecyclerView_android_descendantFocusability, -1) == -1) {
                setDescendantFocusability(262144);
            }
            this.mEnableFastScroller = obtainStyledAttributes2.getBoolean(C0416R.styleable.RecyclerView_fastScrollEnabled, false);
            if (this.mEnableFastScroller) {
                initFastScroller((StateListDrawable) obtainStyledAttributes2.getDrawable(C0416R.styleable.RecyclerView_fastScrollVerticalThumbDrawable), obtainStyledAttributes2.getDrawable(C0416R.styleable.RecyclerView_fastScrollVerticalTrackDrawable), (StateListDrawable) obtainStyledAttributes2.getDrawable(C0416R.styleable.RecyclerView_fastScrollHorizontalThumbDrawable), obtainStyledAttributes2.getDrawable(C0416R.styleable.RecyclerView_fastScrollHorizontalTrackDrawable));
            }
    ...
    public void smoothScrollBy(@C0017Px int i, @C0017Px int i2) {
        smoothScrollBy(i, i2, null);
    }

    public void smoothScrollBy(@C0017Px int i, @C0017Px int i2, @Nullable Interpolator interpolator) {
        LayoutManager layoutManager = this.mLayout;
        if (layoutManager == null) {
            Log.e(TAG, "Cannot smooth scroll without a LayoutManager set. Call setLayoutManager with a non-null argument.");
        } else if (!this.mLayoutFrozen) {
    ...
    private void recoverFocusFromState() {
        ...
        L_0x00b7:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p003v7.widget.RecyclerView.recoverFocusFromState():void");
    }
    ...
    public void initFastScroller(StateListDrawable stateListDrawable, Drawable drawable, StateListDrawable stateListDrawable2, Drawable drawable2) {
        ...
        new FastScroller(this, stateListDrawable, drawable, stateListDrawable2, drawable2, resources.getDimensionPixelSize(C0416R.dimen.fastscroll_default_thickness), resources.getDimensionPixelSize(C0416R.dimen.fastscroll_minimum_range), resources.getDimensionPixelOffset(C0416R.dimen.fastscroll_margin));
    }
