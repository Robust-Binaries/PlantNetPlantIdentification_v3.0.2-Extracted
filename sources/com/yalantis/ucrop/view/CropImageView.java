...
public class CropImageView extends TransformImageView {
    ...
    public void cropAndSaveImage(@NonNull CompressFormat compressFormat, int i, @Nullable BitmapCropCallback bitmapCropCallback) {
        ...
        CropParameters cropParameters = new CropParameters(this.mMaxResultImageSizeX, this.mMaxResultImageSizeY, compressFormat, i, getImageInputPath(), getImageOutputPath(), getExifInfo());
        new BitmapCropTask(getViewBitmap(), imageState, cropParameters, bitmapCropCallback).execute(new Void[0]);
    }
    ...
    public void processStyledAttributes(@NonNull TypedArray typedArray) {
        float abs = Math.abs(typedArray.getFloat(C1313R.styleable.ucrop_UCropView_ucrop_aspect_ratio_x, 0.0f));
        float abs2 = Math.abs(typedArray.getFloat(C1313R.styleable.ucrop_UCropView_ucrop_aspect_ratio_y, 0.0f));
