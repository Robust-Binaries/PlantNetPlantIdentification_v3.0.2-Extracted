...
class IntKeyframeSet extends KeyframeSet {
    ...
    public int getIntValue(float f) {
        if (this.mNumKeyframes == 2) {
            ...
            IntKeyframe intKeyframe2 = (IntKeyframe) this.mKeyframes.get(1);
            ...
            IntKeyframe intKeyframe3 = (IntKeyframe) this.mKeyframes.get(this.mNumKeyframes - 2);
            IntKeyframe intKeyframe4 = (IntKeyframe) this.mKeyframes.get(this.mNumKeyframes - 1);
            ...
            IntKeyframe intKeyframe5 = (IntKeyframe) this.mKeyframes.get(0);
            int i = 1;
            while (i < this.mNumKeyframes) {
                IntKeyframe intKeyframe6 = (IntKeyframe) this.mKeyframes.get(i);
