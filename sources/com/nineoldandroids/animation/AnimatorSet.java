...
public final class AnimatorSet extends Animator {
        ...
        private void startIfReady(Animator animator) {
            if (!this.mAnimatorSet.mTerminated) {
                ...
                while (true) {
                    ...
                    Dependency dependency2 = (Dependency) this.mNode.tmpDependencies.get(i);
    ...
    public void cancel() {
        ...
        if (isStarted()) {
            ...
            if (valueAnimator != null && valueAnimator.isRunning()) {
                ...
                while (it2.hasNext()) {
                    ((Node) it2.next()).animation.cancel();
                }
            }
            if (arrayList != null) {
    ...
    public void start() {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            if (node2.dependencies == null || node2.dependencies.size() == 0) {
                ...
                for (int i3 = 0; i3 < size2; i3++) {
                    Dependency dependency = (Dependency) node2.dependencies.get(i3);
        ...
        if (this.mListeners != null) {
            ...
            for (int i4 = 0; i4 < size3; i4++) {
                ((AnimatorListener) arrayList2.get(i4)).onAnimationStart(this);
            }
        }
        if (this.mNodes.size() == 0 && this.mStartDelay == 0) {
            ...
            if (this.mListeners != null) {
                ...
                for (int i5 = 0; i5 < size4; i5++) {
                    ((AnimatorListener) arrayList3.get(i5)).onAnimationEnd(this);
                }
            }
        }
    }
    ...
    private void sortNodes() {
        ...
        for (int i4 = 0; i4 < size4; i4++) {
            Node node4 = (Node) this.mNodes.get(i4);
            if (node4.dependencies != null && node4.dependencies.size() > 0) {
                int size5 = node4.dependencies.size();
                for (int i5 = 0; i5 < size5; i5++) {
                    Dependency dependency = (Dependency) node4.dependencies.get(i5);
