...
class FloatKeyframeSet extends KeyframeSet {
    ...
    public float getFloatValue(float f) {
        if (this.mNumKeyframes == 2) {
            ...
            FloatKeyframe floatKeyframe2 = (FloatKeyframe) this.mKeyframes.get(1);
            ...
            FloatKeyframe floatKeyframe3 = (FloatKeyframe) this.mKeyframes.get(this.mNumKeyframes - 2);
            FloatKeyframe floatKeyframe4 = (FloatKeyframe) this.mKeyframes.get(this.mNumKeyframes - 1);
            ...
            FloatKeyframe floatKeyframe5 = (FloatKeyframe) this.mKeyframes.get(0);
            int i = 1;
            while (i < this.mNumKeyframes) {
                FloatKeyframe floatKeyframe6 = (FloatKeyframe) this.mKeyframes.get(i);
