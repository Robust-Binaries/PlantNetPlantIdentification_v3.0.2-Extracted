...
public class RNGestureHandlerModule extends ReactContextBaseJavaModule {
    ...
    public Map getConstants() {
        return MapBuilder.m122of("State", MapBuilder.m126of("UNDETERMINED", Integer.valueOf(0), "BEGAN", Integer.valueOf(2), "ACTIVE", Integer.valueOf(4), "CANCELLED", Integer.valueOf(3), "FAILED", Integer.valueOf(1), "END", Integer.valueOf(5)), "Direction", MapBuilder.m124of("RIGHT", Integer.valueOf(1), "LEFT", Integer.valueOf(2), "UP", Integer.valueOf(4), "DOWN", Integer.valueOf(8)));
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:23:0x0052, code lost:
        r0.addUIBlock(new com.swmansion.gesturehandler.react.RNGestureHandlerModule.C12632(r4));
     */
    ...
    public static void handleHitSlopProperty(GestureHandler gestureHandler, ReadableMap readableMap) {
        ...
        gestureHandler.setHitSlop(map.hasKey("left") ? PixelUtil.toPixelFromDIP(map.getDouble("left")) : f2, map.hasKey("top") ? PixelUtil.toPixelFromDIP(map.getDouble("top")) : f3, map.hasKey("right") ? PixelUtil.toPixelFromDIP(map.getDouble("right")) : f, map.hasKey("bottom") ? PixelUtil.toPixelFromDIP(map.getDouble("bottom")) : f4, map.hasKey("width") ? PixelUtil.toPixelFromDIP(map.getDouble("width")) : Float.NaN, map.hasKey("height") ? PixelUtil.toPixelFromDIP(map.getDouble("height")) : Float.NaN);
    }
}
