...
public class UIViewOperationQueue {
    ...
    private final class UpdateLayoutOperation extends ViewOperation {
        ...
        /* renamed from: mX */
        private final int f71mX;

        /* renamed from: mY */
        private final int f72mY;
        ...
        public void execute() {
            ...
            UIViewOperationQueue.this.mNativeViewHierarchyManager.updateLayout(this.mParentTag, this.mTag, this.f71mX, this.f72mY, this.mWidth, this.mHeight);
        }
    }
    ...
    public void enqueueUpdateInstanceHandle(int i, long j) {
        ArrayList<UIOperation> arrayList = this.mOperations;
        UpdateInstanceHandleOperation updateInstanceHandleOperation = new UpdateInstanceHandleOperation(i, j);
        arrayList.add(updateInstanceHandleOperation);
    }
    ...
    public void enqueueOnLayoutEvent(int i, int i2, int i3, int i4, int i5) {
        ArrayList<UIOperation> arrayList = this.mOperations;
        EmitOnLayoutEventOperation emitOnLayoutEventOperation = new EmitOnLayoutEventOperation(i, i2, i3, i4, i5);
        arrayList.add(emitOnLayoutEventOperation);
    }
    ...
    public void dispatchViewUpdates(int r19, long r20, long r22) {
        /*
            ...
            r1.flush()
            long r10 = android.os.SystemClock.uptimeMillis()     // Catch:{ all -> 0x00a4 }
            long r15 = android.os.SystemClock.currentThreadTimeMillis()     // Catch:{ all -> 0x00a4 }
            java.util.ArrayList<com.facebook.react.uimanager.UIViewOperationQueue$UIOperation> r1 = r14.mOperations     // Catch:{ all -> 0x00a4 }
            ...
            r14.mOperations = r3     // Catch:{ all -> 0x00a4 }
            r5 = r1
            goto L_0x0032
        L_0x0031:
            r5 = r2
        L_0x0032:
            java.lang.Object r1 = r14.mNonBatchedOperationsLock     // Catch:{ all -> 0x00a4 }
            monitor-enter(r1)     // Catch:{ all -> 0x00a4 }
            java.util.ArrayDeque<com.facebook.react.uimanager.UIViewOperationQueue$UIOperation> r3 = r14.mNonBatchedOperations     // Catch:{ all -> 0x009c }
            boolean r3 = r3.isEmpty()     // Catch:{ all -> 0x009c }
            if (r3 != 0) goto L_0x0048
            java.util.ArrayDeque<com.facebook.react.uimanager.UIViewOperationQueue$UIOperation> r2 = r14.mNonBatchedOperations     // Catch:{ all -> 0x009c }
            java.util.ArrayDeque r3 = new java.util.ArrayDeque     // Catch:{ all -> 0x009c }
            r3.<init>()     // Catch:{ all -> 0x009c }
            r14.mNonBatchedOperations = r3     // Catch:{ all -> 0x009c }
            r4 = r2
            goto L_0x0049
        L_0x0048:
            r4 = r2
        L_0x0049:
            ...
            com.facebook.react.uimanager.debug.NotThreadSafeViewHierarchyUpdateDebugListener r1 = r14.mViewHierarchyUpdateDebugListener     // Catch:{ all -> 0x00a4 }
            if (r1 == 0) goto L_0x0053
            com.facebook.react.uimanager.debug.NotThreadSafeViewHierarchyUpdateDebugListener r1 = r14.mViewHierarchyUpdateDebugListener     // Catch:{ all -> 0x00a4 }
            r1.onViewHierarchyUpdateEnqueued()     // Catch:{ all -> 0x00a4 }
        L_0x0053:
            com.facebook.react.uimanager.UIViewOperationQueue$1 r8 = new com.facebook.react.uimanager.UIViewOperationQueue$1     // Catch:{ all -> 0x00a4 }
            r1 = r8
            r2 = r18
            r3 = r19
            r6 = r20
            ...
            r8 = r22
            r12 = r15
            r1.<init>(r3, r4, r5, r6, r8, r10, r12)     // Catch:{ all -> 0x0098 }
            java.lang.String r1 = "acquiring mDispatchRunnablesLock"
            r2 = 0
            com.facebook.systrace.SystraceMessage$Builder r1 = com.facebook.systrace.SystraceMessage.beginSection(r2, r1)     // Catch:{ all -> 0x00a0 }
            java.lang.String r4 = "batchId"
            com.facebook.systrace.SystraceMessage$Builder r0 = r1.arg(r4, r0)     // Catch:{ all -> 0x00a0 }
            r0.flush()     // Catch:{ all -> 0x00a0 }
            java.lang.Object r1 = r14.mDispatchRunnablesLock     // Catch:{ all -> 0x00a0 }
            monitor-enter(r1)     // Catch:{ all -> 0x00a0 }
            com.facebook.systrace.Systrace.endSection(r2)     // Catch:{ all -> 0x0095 }
            java.util.ArrayList<java.lang.Runnable> r0 = r14.mDispatchUIRunnables     // Catch:{ all -> 0x0095 }
            r4 = r17
            r0.add(r4)     // Catch:{ all -> 0x0095 }
            monitor-exit(r1)     // Catch:{ all -> 0x0095 }
            boolean r0 = r14.mIsDispatchUIFrameCallbackEnqueued     // Catch:{ all -> 0x00a0 }
            if (r0 != 0) goto L_0x0091
            com.facebook.react.uimanager.UIViewOperationQueue$2 r0 = new com.facebook.react.uimanager.UIViewOperationQueue$2     // Catch:{ all -> 0x00a0 }
            com.facebook.react.bridge.ReactApplicationContext r1 = r14.mReactApplicationContext     // Catch:{ all -> 0x00a0 }
            r0.<init>(r1)     // Catch:{ all -> 0x00a0 }
            com.facebook.react.bridge.UiThreadUtil.runOnUiThread(r0)     // Catch:{ all -> 0x00a0 }
        L_0x0091:
    ...
    public void flushPendingBatches() {
        /*
            ...
            com.facebook.common.logging.FLog.m88w(r0, r1)
            return
        L_0x000c:
