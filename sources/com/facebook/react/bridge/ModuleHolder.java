...
public class ModuleHolder {
    ...
    public com.facebook.react.bridge.NativeModule getModule() {
        ...
        L_0x0032:
            com.facebook.react.bridge.NativeModule r0 = r3.mModule     // Catch:{ all -> 0x003c }
            java.lang.Object r0 = com.facebook.infer.annotation.Assertions.assertNotNull(r0)     // Catch:{ all -> 0x003c }
    ...
    private NativeModule create() {
        ...
        SystraceMessage.beginSection(0, "ModuleHolder.createModule").arg(ConditionalUserProperty.NAME, (Object) this.mName).flush();
        PrinterHolder.getPrinter().logMessage(ReactDebugOverlayTags.NATIVE_MODULE, "NativeModule init: %s", this.mName);
        try {
    ...
    private void doInitialize(NativeModule nativeModule) {
        boolean z;
        SystraceMessage.beginSection(0, "ModuleHolder.initialize").arg(ConditionalUserProperty.NAME, (Object) this.mName).flush();
