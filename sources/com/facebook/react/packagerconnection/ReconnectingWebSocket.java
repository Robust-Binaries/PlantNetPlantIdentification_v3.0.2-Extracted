...
public final class ReconnectingWebSocket extends WebSocketListener {
    ...
    public synchronized void onOpen(WebSocket webSocket, C1512Response response) {
    ...
    public synchronized void onFailure(WebSocket webSocket, Throwable th, C1512Response response) {
