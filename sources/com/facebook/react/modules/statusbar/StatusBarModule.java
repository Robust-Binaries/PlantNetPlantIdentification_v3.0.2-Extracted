...
public class StatusBarModule extends ReactContextBaseJavaModule {
    ...
    public Map<String, Object> getConstants() {
        ...
        String str = "black";
        if (currentActivity != null && VERSION.SDK_INT >= 21) {
            str = String.format("#%06X", new Object[]{Integer.valueOf(currentActivity.getWindow().getStatusBarColor() & ViewCompat.MEASURED_SIZE_MASK)});
        }
        return MapBuilder.m122of(HEIGHT_KEY, Float.valueOf(dIPFromPixel), DEFAULT_BACKGROUND_COLOR_KEY, str);
    }
    ...
    public void setColor(int i, boolean z) {
        ...
        if (currentActivity == null) {
            FLog.m88w(ReactConstants.TAG, "StatusBarModule: Ignored status bar change, current activity is null.");
            return;
        }
        if (VERSION.SDK_INT >= 21) {
            final boolean z2 = z;
            final int i2 = i;
            C09861 r0 = new GuardedRunnable(getReactApplicationContext()) {
                @TargetApi(21)
