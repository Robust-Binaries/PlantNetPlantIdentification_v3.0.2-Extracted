...
public class ImageLoaderModule extends ReactContextBaseJavaModule implements LifecycleEventListener {
    ...
    public void prefetchImage(String str, final int i, final Promise promise) {
        ...
        DataSource prefetchToDiskCache = Fresco.getImagePipeline().prefetchToDiskCache(ImageRequestBuilder.newBuilderWithSource(Uri.parse(str)).build(), this.mCallerContext);
        C09632 r0 = new BaseDataSubscriber<Void>() {
            /* access modifiers changed from: protected */
    ...
    public void abortRequest(int i) {
        DataSource removeRequest = removeRequest(i);
