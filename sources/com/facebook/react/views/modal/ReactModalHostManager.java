...
public class ReactModalHostManager extends ViewGroupManager<ReactModalHostView> {
    ...
    public Map<String, Object> getExportedCustomDirectEventTypeConstants() {
        return MapBuilder.builder().put(RequestCloseEvent.EVENT_NAME, MapBuilder.m121of("registrationName", "onRequestClose")).put(ShowEvent.EVENT_NAME, MapBuilder.m121of("registrationName", "onShow")).build();
    }
