...
public class DevServerHelper {
    ...
    public void openPackagerConnection(final String str, final PackagerCommandListener packagerCommandListener) {
        if (this.mPackagerClient != null) {
            FLog.m88w(ReactConstants.TAG, "Packager connection already open, nooping.");
        } else {
            new AsyncTask<Void, Void, Void>() {
                ...
                public Void doInBackground(Void... voidArr) {
                    ...
                    C08834 r0 = new ConnectionCallback() {
    ...
    public void openInspectorConnection() {
        if (this.mInspectorPackagerConnection != null) {
            FLog.m88w(ReactConstants.TAG, "Inspector connection already open, nooping.");
        } else {
            new AsyncTask<Void, Void, Void>() {
                /* access modifiers changed from: protected */
                public Void doInBackground(Void... voidArr) {
        ...
        new AsyncTask<Void, String, Boolean>() {
            ...
            public boolean doSync() {
                try {
                    ...
                    FLog.m49e(ReactConstants.TAG, "Failed to send attach request to Inspector", (Throwable) e);
                    return false;
                }
            }
            ...
            public void onPostExecute(Boolean bool) {
                if (!bool.booleanValue()) {
                    Toast.makeText(context, context.getString(C0788R.string.catalyst_debugjs_nuclide_failure), 1).show();
                }
            }
        }.executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, new Void[0]);
    }
    ...
    public void isPackagerRunning(final PackagerStatusCallback packagerStatusCallback) {
        this.mClient.newCall(new Request.Builder().url(createPackagerStatusURL(this.mSettings.getPackagerConnectionSettings().getDebugServerHost())).build()).enqueue(new Callback() {
            ...
            public void onResponse(Call call, C1512Response response) throws IOException {
                ...
                if (body == null) {
                    FLog.m48e(ReactConstants.TAG, "Got null body response from packager when requesting status");
                    packagerStatusCallback.onPackagerStatusFetched(false);
                    return;
                }
    ...
    public void startPollingOnChangeEndpoint(OnServerContentChangeListener onServerContentChangeListener) {
        if (!this.mOnChangePollingEnabled) {
            ...
            this.mOnChangePollingClient = new Builder().connectionPool(new ConnectionPool(1, 120000, TimeUnit.MILLISECONDS)).connectTimeout(5000, TimeUnit.MILLISECONDS).build();
        ...
        ((OkHttpClient) Assertions.assertNotNull(this.mOnChangePollingClient)).newCall(new Request.Builder().url(createOnChangeEndpointUrl()).tag(this).build()).enqueue(new Callback() {
            public void onFailure(Call call, IOException iOException) {
                if (DevServerHelper.this.mOnChangePollingEnabled) {
                    FLog.m41d(ReactConstants.TAG, "Error while requesting /onchange endpoint", (Throwable) iOException);
    ...
    public java.io.File downloadBundleResourceFromUrlSync(java.lang.String r8, java.io.File r9) {
        ...
        L_0x0031:
            return r1
        L_0x0032:
            okio.Sink r2 = okio.Okio.sink(r9)     // Catch:{ all -> 0x0052 }
            okhttp3.ResponseBody r3 = r0.body()     // Catch:{ all -> 0x0050 }
            okio.BufferedSource r3 = r3.source()     // Catch:{ all -> 0x0050 }
            okio.BufferedSource r3 = okio.Okio.buffer(r3)     // Catch:{ all -> 0x0050 }
        ...
        L_0x0074:
            ...
            r8 = 2
            r4[r8] = r0
            com.facebook.common.logging.FLog.m50e(r2, r3, r4)
            return r1
        */
