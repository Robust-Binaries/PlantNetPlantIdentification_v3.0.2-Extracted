...
public class DevLoadingViewController {
    ...
    public void showForUrl(String str) {
        ...
        if (context != null) {
            try {
                URL url = new URL(str);
                int i = C0788R.string.catalyst_loading_from_url;
    ...
    public void showForRemoteJSEnabled() {
        Context context = getContext();
        if (context != null) {
            showMessage(context.getString(C0788R.string.catalyst_remotedbg_message));
        }
    }
    ...
    public void showInternal(String str) {
        ...
        if (popupWindow == null || !popupWindow.isShowing()) {
            ...
            if (currentActivity == null) {
                FLog.m48e(ReactConstants.TAG, "Unable to display loading message because react activity isn't available");
                return;
            }
            Rect rect = new Rect();
            currentActivity.getWindow().getDecorView().getWindowVisibleDisplayFrame(rect);
            int i = rect.top;
            this.mDevLoadingView = (TextView) ((LayoutInflater) currentActivity.getSystemService("layout_inflater")).inflate(C0788R.layout.dev_loading_view, null);
