...
public class FpsView extends FrameLayout {
    ...
    private final TextView mTextView = ((TextView) findViewById(C0788R.C0791id.fps_text));
    ...
    public FpsView(ReactContext reactContext) {
        super(reactContext);
        inflate(reactContext, C0788R.layout.fps_view, this);
    ...
    public void setCurrentFPS(double d, double d2, int i, int i2) {
        ...
        FLog.m36d(ReactConstants.TAG, format);
    }
}
