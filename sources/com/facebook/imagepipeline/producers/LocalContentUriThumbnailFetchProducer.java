    ...
    private EncodedImage getCameraImage(Uri uri, ResizeOptions resizeOptions) throws IOException {
        ...
        try {
            ...
            if (resizeOptions != null) {
                EncodedImage thumbnail = getThumbnail(resizeOptions, query.getInt(query.getColumnIndex("_id")));
                if (thumbnail != null) {
    ...
    private static int getRotationAngle(String str) {
        if (str != null) {
            try {
                ...
                FLog.m47e(TAG, (Throwable) e, "Unable to retrieve thumbnail rotation for %s", str);
            }
        }
        return 0;
    }
