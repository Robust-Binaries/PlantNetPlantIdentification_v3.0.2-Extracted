...
public class WebpTranscodeProducer implements Producer<EncodedImage> {
    ...
    public void transcodeLastResult(EncodedImage encodedImage, Consumer<EncodedImage> consumer, ProducerContext producerContext) {
        ...
        C07731 r0 = new StatefulProducerRunnable<EncodedImage>(consumer, producerContext.getListener(), PRODUCER_NAME, producerContext.getId()) {
            /* access modifiers changed from: protected */
            public EncodedImage getResult() throws Exception {
                ...
                try {
                    ...
                    of = CloseableReference.m112of(newOutputStream.toByteBuffer());
