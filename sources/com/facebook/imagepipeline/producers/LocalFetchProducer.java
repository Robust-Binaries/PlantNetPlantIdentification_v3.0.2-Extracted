...
public abstract class LocalFetchProducer implements Producer<EncodedImage> {
    ...
    public void produceResults(Consumer<EncodedImage> consumer, ProducerContext producerContext) {
        ...
        final C07521 r0 = new StatefulProducerRunnable<EncodedImage>(consumer, listener, getProducerName(), id) {
            /* access modifiers changed from: protected */
    ...
    public EncodedImage getByteBufferBackedEncodedImage(InputStream inputStream, int i) throws IOException {
        ...
        if (i <= 0) {
            try {
                closeableReference = CloseableReference.m112of(this.mPooledByteBufferFactory.newByteBuffer(inputStream));
            } catch (Throwable th) {
            ...
            closeableReference = CloseableReference.m112of(this.mPooledByteBufferFactory.newByteBuffer(inputStream, i));
        }
