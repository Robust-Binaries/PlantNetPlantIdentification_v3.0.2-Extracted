...
public class ProducerFactory {
    ...
    public DecodeProducer newDecodeProducer(Producer<EncodedImage> producer) {
        DecodeProducer decodeProducer = new DecodeProducer(this.mByteArrayPool, this.mExecutorSupplier.forDecode(), this.mImageDecoder, this.mProgressiveJpegConfig, this.mDownsampleEnabled, this.mResizeAndRotateEnabledForNetwork, this.mDecodeCancellationEnabled, producer);
    ...
    public ResizeAndRotateProducer newResizeAndRotateProducer(Producer<EncodedImage> producer, boolean z, boolean z2) {
        ResizeAndRotateProducer resizeAndRotateProducer = new ResizeAndRotateProducer(this.mExecutorSupplier.forBackgroundTasks(), this.mPooledByteBufferFactory, z && !this.mDownsampleEnabled, producer, z2);
