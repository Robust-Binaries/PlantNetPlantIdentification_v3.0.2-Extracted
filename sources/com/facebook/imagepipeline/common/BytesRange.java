...
public class BytesRange {
    ...
    public String toHttpRangeHeaderValue() {
        return String.format(null, "bytes=%s-%s", new Object[]{valueOrEmpty(this.from), valueOrEmpty(this.f53to)});
    }
    ...
    public boolean contains(@Nullable BytesRange bytesRange) {
        ...
        if (this.from <= bytesRange.from && this.f53to >= bytesRange.f53to) {
            z = true;
        }
        return z;
    }
    ...
    public String toString() {
        return String.format(null, "%s-%s", new Object[]{valueOrEmpty(this.from), valueOrEmpty(this.f53to)});
    }
    ...
    public int hashCode() {
        return HashCodeUtil.hashCode(this.from, this.f53to);
    }
