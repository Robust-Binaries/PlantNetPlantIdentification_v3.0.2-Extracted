...
import com.facebook.drawee.C0662R;
    ...
    private void init(Context context, @Nullable AttributeSet attributeSet) {
        if (!isInEditMode()) {
            ...
            if (attributeSet != null) {
                TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0662R.styleable.SimpleDraweeView);
                try {
                    if (obtainStyledAttributes.hasValue(C0662R.styleable.SimpleDraweeView_actualImageUri)) {
                        setImageURI(Uri.parse(obtainStyledAttributes.getString(C0662R.styleable.SimpleDraweeView_actualImageUri)), (Object) null);
                    } else if (obtainStyledAttributes.hasValue(C0662R.styleable.SimpleDraweeView_actualImageResource)) {
                        int resourceId = obtainStyledAttributes.getResourceId(C0662R.styleable.SimpleDraweeView_actualImageResource, -1);
                        if (resourceId != -1) {
