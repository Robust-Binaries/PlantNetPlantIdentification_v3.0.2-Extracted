...
public class GenericDraweeHierarchy implements SettableDraweeHierarchy {
    ...
    @Nullable
    private Drawable buildActualImageBranch(Drawable drawable, @Nullable ScaleType scaleType, @Nullable PointF pointF, @Nullable ColorFilter colorFilter) {
    ...
    private ScaleTypeDrawable getScaleTypeDrawableAtIndex(int i) {
        ...
        return WrappingUtils.wrapChildWithScaleType(parentDrawableAtIndex, ScaleType.FIT_XY);
    }
