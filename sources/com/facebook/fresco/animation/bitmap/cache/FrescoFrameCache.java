...
public class FrescoFrameCache implements BitmapFrameCache {
        ...
        try {
            ...
            if (closeableReference2 != null) {
                ...
                if (CloseableReference.isValid(cache)) {
                    ...
                    FLog.m70v(TAG, "cachePreparedFrame(%d) cached. Pending frames: %s", (Object) Integer.valueOf(i), (Object) this.mPreparedPendingFrames);
                }
    ...
    private synchronized void removePreparedReference(int i) {
        ...
        if (closeableReference != null) {
            ...
            FLog.m70v(TAG, "removePreparedReference(%d) removed. Pending frames: %s", (Object) Integer.valueOf(i), (Object) this.mPreparedPendingFrames);
        }
    }
    ...
    private static CloseableReference<CloseableImage> createImageReference(CloseableReference<Bitmap> closeableReference) {
        return CloseableReference.m112of(new CloseableStaticBitmap(closeableReference, ImmutableQualityInfo.FULL_QUALITY, 0));
    }
}
