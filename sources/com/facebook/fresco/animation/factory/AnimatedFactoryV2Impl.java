...
public class AnimatedFactoryV2Impl implements AnimatedFactory {
    ...
    private ExperimentalBitmapAnimationDrawableFactory createDrawableFactory() {
        C06833 r7 = new Supplier<Integer>() {
            public Integer get() {
                return Integer.valueOf(2);
            }
        };
        ExperimentalBitmapAnimationDrawableFactory experimentalBitmapAnimationDrawableFactory = new ExperimentalBitmapAnimationDrawableFactory(getAnimatedDrawableBackendProvider(), UiThreadImmediateExecutorService.getInstance(), new DefaultSerialExecutorService(this.mExecutorSupplier.forDecode()), RealtimeSinceBootClock.get(), this.mPlatformBitmapFactory, this.mBackingCache, r7, new Supplier<Integer>() {
            public Integer get() {
