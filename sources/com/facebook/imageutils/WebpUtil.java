...
public class WebpUtil {
    ...
    private static Pair<Integer, Integer> getVP8LDimension(InputStream inputStream) throws IOException {
        ...
        byte read = ((byte) inputStream.read()) & UByte.MAX_VALUE;
        return new Pair<>(Integer.valueOf(((((byte) inputStream.read()) & UByte.MAX_VALUE) | ((read & 63) << 8)) + 1), Integer.valueOf(((((((byte) inputStream.read()) & UByte.MAX_VALUE) & 15) << 10) | ((((byte) inputStream.read()) & UByte.MAX_VALUE) << 2) | ((read & 192) >> 6)) + 1));
    }
    ...
    private static int getInt(InputStream inputStream) throws IOException {
        return ((((byte) inputStream.read()) << 24) & -16777216) | ((((byte) inputStream.read()) << 16) & 16711680) | ((((byte) inputStream.read()) << 8) & 65280) | (((byte) inputStream.read()) & UByte.MAX_VALUE);
    }
    ...
    private static int read3Bytes(InputStream inputStream) throws IOException {
        ...
        return ((getByte(inputStream) << 16) & 16711680) | ((getByte(inputStream) << 8) & 65280) | (b & UByte.MAX_VALUE);
    }
