...
public final class BitmapUtil {
    ...
    static /* synthetic */ class C07761 {
        ...
        static {
            ...
            L_0x0035:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.imageutils.BitmapUtil.C07761.<clinit>():void");
        }
    }
    ...
    public static int getPixelSizeForBitmapConfig(Config config) {
        switch (C07761.$SwitchMap$android$graphics$Bitmap$Config[config.ordinal()]) {
            case 1:
                return 4;
            case 2:
                return 1;
