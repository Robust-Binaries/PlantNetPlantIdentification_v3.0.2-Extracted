...
import com.google.firebase.components.Component.C11401;
...
public class FirebaseApp {
    ...
    public String toString() {
        return Objects.toStringHelper(this).add(ConditionalUserProperty.NAME, this.zzj).add("options", this.zzk).toString();
    }
    ...
    private FirebaseApp(Context context, String str, FirebaseOptions firebaseOptions) {
        ...
        List zza2 = C11401.zza(context).zza();
        this.zzl = new zzf(zzh, zza2, Component.m154of(context, Context.class, new Class[0]), Component.m154of(this, FirebaseApp.class, new Class[0]), Component.m154of(firebaseOptions, FirebaseOptions.class, new Class[0]));
