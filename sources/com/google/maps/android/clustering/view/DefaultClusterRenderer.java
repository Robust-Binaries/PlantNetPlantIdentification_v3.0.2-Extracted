...
public class DefaultClusterRenderer<T extends ClusterItem> implements ClusterRenderer<T> {
    ...
    private static final int[] BUCKETS = {10, 20, 50, 100, Callback.DEFAULT_DRAG_ANIMATION_DURATION, CropImageView.DEFAULT_IMAGE_TO_CROP_BOUNDS_ANIM_DURATION, 1000};
    /* access modifiers changed from: private */
    ...
    private class AnimationTask extends AnimatorListenerAdapter implements AnimatorUpdateListener {
        ...
        public void onAnimationEnd(Animator animator) {
            ...
            this.markerWithPosition.position = this.f80to;
        }
    ...
    public DefaultClusterRenderer(Context context, GoogleMap googleMap, ClusterManager<T> clusterManager) {
        ...
        this.mIconGenerator.setTextAppearance(C1147R.style.amu_ClusterIcon_TextAppearance);
    ...
    private SquareTextView makeSquareTextView(Context context) {
        ...
        squareTextView.setId(C1147R.C1150id.amu_text);
    ...
    private static double distanceSquared(Point point, Point point2) {
        return ((point.f81x - point2.f81x) * (point.f81x - point2.f81x)) + ((point.f82y - point2.f82y) * (point.f82y - point2.f82y));
    }
