...
public class PointQuadTree<T extends Item> {
    ...
    public void add(T t) {
        ...
        if (this.mBounds.contains(point.f81x, point.f82y)) {
            insert(point.f81x, point.f82y, t);
        }
    }
    ...
    private void split() {
        ...
        this.mItems = null;
        for (T t : list5) {
            insert(t.getPoint().f81x, t.getPoint().f82y, t);
        }
    }
    ...
    public boolean remove(T t) {
        ...
        return remove(point.f81x, point.f82y, t);
    }
