...
interface zzil {
    ...
    void zza(int i, zzdp zzdp) throws IOException;

    <K, V> void zza(int i, zzga<K, V> zzga, Map<K, V> map) throws IOException;

    void zza(int i, Object obj) throws IOException;

    void zza(int i, Object obj, zzgy zzgy) throws IOException;

    void zza(int i, List<String> list) throws IOException;

    void zza(int i, List<?> list, zzgy zzgy) throws IOException;
    ...
    @Deprecated
    void zzb(int i, Object obj, zzgy zzgy) throws IOException;
    ...
    @Deprecated
    void zzb(int i, List<?> list, zzgy zzgy) throws IOException;
