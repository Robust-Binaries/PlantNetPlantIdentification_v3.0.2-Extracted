...
public final class ConnectionResult extends AbstractSafeParcelable {
    ...
    @Field(getter = "getErrorCode", mo15077id = 2)
    private final int zzh;
    @Field(getter = "getResolution", mo15077id = 3)
    private final PendingIntent zzi;
    @Field(getter = "getErrorMessage", mo15077id = 4)
    private final String zzj;

    @Constructor
    ConnectionResult(@Param(mo15080id = 1) int i, @Param(mo15080id = 2) int i2, @Param(mo15080id = 3) PendingIntent pendingIntent, @Param(mo15080id = 4) String str) {
        this.zzg = i;
        this.zzh = i2;
