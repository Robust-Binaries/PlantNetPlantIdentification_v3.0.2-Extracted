...
public final class Status extends AbstractSafeParcelable implements Result, ReflectedParcelable {
    ...
    @Field(getter = "getStatusCode", mo15077id = 1)
    private final int zzh;
    @Nullable
    @Field(getter = "getPendingIntent", mo15077id = 3)
    private final PendingIntent zzi;
    @Nullable
    @Field(getter = "getStatusMessage", mo15077id = 2)
    private final String zzj;

    @Constructor
    @KeepForSdk
    Status(@Param(mo15080id = 1000) int i, @Param(mo15080id = 1) int i2, @Nullable @Param(mo15080id = 2) String str, @Nullable @Param(mo15080id = 3) PendingIntent pendingIntent) {
        this.zzg = i;
        this.zzh = i2;
        this.zzj = str;
