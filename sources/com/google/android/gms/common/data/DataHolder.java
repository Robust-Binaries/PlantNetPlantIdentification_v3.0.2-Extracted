...
public final class DataHolder extends AbstractSafeParcelable implements Closeable {
    ...
    @VersionField(mo15083id = 1000)
    private final int zalf;
    @Field(getter = "getColumns", mo15077id = 1)
    private final String[] zalq;
    private Bundle zalr;
    @Field(getter = "getWindows", mo15077id = 2)
    private final CursorWindow[] zals;
    @Field(getter = "getStatusCode", mo15077id = 3)
    private final int zalt;
    @Field(getter = "getMetadata", mo15077id = 4)
    ...
    @Constructor
    DataHolder(@Param(mo15080id = 1000) int i, @Param(mo15080id = 1) String[] strArr, @Param(mo15080id = 2) CursorWindow[] cursorWindowArr, @Param(mo15080id = 3) int i2, @Param(mo15080id = 4) Bundle bundle) {
        this.mClosed = false;
        this.zalx = true;
        this.zalf = i;
        this.zalq = strArr;
