...
public final class WebImage extends AbstractSafeParcelable {
    ...
    @Field(getter = "getHeight", mo15077id = 4)
    private final int zanf;
    @Field(getter = "getUrl", mo15077id = 2)
    private final Uri zang;

    @Constructor
    WebImage(@Param(mo15080id = 1) int i, @Param(mo15080id = 2) Uri uri, @Param(mo15080id = 3) int i2, @Param(mo15080id = 4) int i3) {
        this.zalf = i;
        this.zang = uri;
        this.zane = i2;
        this.zanf = i3;
