...
public class ResolveAccountRequest extends AbstractSafeParcelable {
    ...
    @Field(getter = "getSessionId", mo15077id = 3)
    private final int zapa;
    @Field(getter = "getSignInAccountHint", mo15077id = 4)
    private final GoogleSignInAccount zapb;
    @Field(getter = "getAccount", mo15077id = 2)
    private final Account zax;

    @Constructor
    ResolveAccountRequest(@Param(mo15080id = 1) int i, @Param(mo15080id = 2) Account account, @Param(mo15080id = 3) int i2, @Param(mo15080id = 4) GoogleSignInAccount googleSignInAccount) {
        this.zalf = i;
        this.zax = account;
        this.zapa = i2;
