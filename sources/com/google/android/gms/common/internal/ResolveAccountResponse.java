...
public class ResolveAccountResponse extends AbstractSafeParcelable {
    ...
    @Field(getter = "getConnectionResult", mo15077id = 3)
    private ConnectionResult zadi;
    @Field(getter = "getSaveDefaultAccount", mo15077id = 4)
    private boolean zagg;
    @VersionField(mo15083id = 1)
    private final int zalf;
    @Field(mo15077id = 2)
    private IBinder zanx;
    @Field(getter = "isFromCrossClientAuth", mo15077id = 5)
    private boolean zapc;

    @Constructor
    ResolveAccountResponse(@Param(mo15080id = 1) int i, @Param(mo15080id = 2) IBinder iBinder, @Param(mo15080id = 3) ConnectionResult connectionResult, @Param(mo15080id = 4) boolean z, @Param(mo15080id = 5) boolean z2) {
        this.zalf = i;
        this.zanx = iBinder;
