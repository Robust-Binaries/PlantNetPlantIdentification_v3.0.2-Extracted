...
public class ClientIdentity extends AbstractSafeParcelable {
    ...
    @Nullable
    @Field(defaultValueUnchecked = "null", mo15077id = 2)
    private final String packageName;
    @Field(defaultValueUnchecked = "0", mo15077id = 1)
    private final int uid;

    @Constructor
    public ClientIdentity(@Param(mo15080id = 1) int i, @Nullable @Param(mo15080id = 2) String str) {
        this.uid = i;
