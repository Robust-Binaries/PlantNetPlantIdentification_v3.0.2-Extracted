...
public final class zak extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getSerializedDictionary", mo15077id = 2)
    private final ArrayList<zal> zaqw;
    @SafeParcelable.Field(getter = "getRootClassName", mo15077id = 3)
    private final String zaqx;

    @Constructor
    zak(@Param(mo15080id = 1) int i, @Param(mo15080id = 2) ArrayList<zal> arrayList, @Param(mo15080id = 3) String str) {
        this.zalf = i;
        this.zaqw = null;
