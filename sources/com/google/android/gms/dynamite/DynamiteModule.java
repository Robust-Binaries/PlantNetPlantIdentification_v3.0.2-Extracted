...
public final class DynamiteModule {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:69:0x00e4 A[Catch:{ LoadingException -> 0x00c2, Throwable -> 0x00ec }] */
    ...
    public static int zza(android.content.Context r8, java.lang.String r9, boolean r10) {
        /*
            ...
            java.lang.Boolean r1 = zzif     // Catch:{ all -> 0x00e9 }
        ...
        L_0x00b4:
            zzif = r1     // Catch:{ all -> 0x00e9 }
        L_0x00b6:
            monitor-exit(r0)     // Catch:{ all -> 0x00e9 }
            boolean r0 = r1.booleanValue()     // Catch:{ Throwable -> 0x00ec }
            if (r0 == 0) goto L_0x00e4
            int r8 = zzc(r8, r9, r10)     // Catch:{ LoadingException -> 0x00c2 }
            return r8
        L_0x00c2:
            r9 = move-exception
        ...
        L_0x00df:
            ...
            return r8
        L_0x00e4:
            int r8 = zzb(r8, r9, r10)     // Catch:{ Throwable -> 0x00ec }
            return r8
        L_0x00e9:
            r9 = move-exception
            monitor-exit(r0)     // Catch:{ all -> 0x00e9 }
