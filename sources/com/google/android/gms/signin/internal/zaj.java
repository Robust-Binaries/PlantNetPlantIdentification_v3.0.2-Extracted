...
public final class zaj extends AbstractSafeParcelable {
    ...
    @Field(getter = "getConnectionResult", mo15077id = 2)
    private final ConnectionResult zadi;
    @VersionField(mo15083id = 1)
    private final int zalf;
    @Field(getter = "getResolveAccountResponse", mo15077id = 3)
    private final ResolveAccountResponse zase;

    @Constructor
    zaj(@Param(mo15080id = 1) int i, @Param(mo15080id = 2) ConnectionResult connectionResult, @Param(mo15080id = 3) ResolveAccountResponse resolveAccountResponse) {
        this.zalf = i;
