...
public class GoogleSignInOptionsExtensionParcelable extends AbstractSafeParcelable {
    ...
    @Field(getter = "getBundle", mo15077id = 3)
    ...
    @Constructor
    GoogleSignInOptionsExtensionParcelable(@Param(mo15080id = 1) int i, @Param(mo15080id = 2) int i2, @Param(mo15080id = 3) Bundle bundle) {
        this.versionCode = i;
        this.mType = i2;
        this.mBundle = bundle;
    }
