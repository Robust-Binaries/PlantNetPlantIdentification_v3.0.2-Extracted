...
public class GoogleSignInOptions extends AbstractSafeParcelable implements Optional, ReflectedParcelable {
    ...
    @Field(getter = "isForceCodeForRefreshToken", mo15077id = 6)
    public final boolean zaaa;
    /* access modifiers changed from: private */
    @Field(getter = "getServerClientId", mo15077id = 7)
    public String zaab;
    /* access modifiers changed from: private */
    @Field(getter = "getHostedDomain", mo15077id = 8)
    public String zaac;
    /* access modifiers changed from: private */
    @Field(getter = "getExtensions", mo15077id = 9)
    ...
    /* access modifiers changed from: private */
    @Field(getter = "getScopes", mo15077id = 2)
    public final ArrayList<Scope> zaw;
    /* access modifiers changed from: private */
    @Field(getter = "getAccount", mo15077id = 3)
    public Account zax;
    /* access modifiers changed from: private */
    @Field(getter = "isIdTokenRequested", mo15077id = 4)
    public boolean zay;
    /* access modifiers changed from: private */
    @Field(getter = "isServerAuthCodeRequested", mo15077id = 5)
    ...
    @Constructor
    GoogleSignInOptions(@Param(mo15080id = 1) int i, @Param(mo15080id = 2) ArrayList<Scope> arrayList, @Param(mo15080id = 3) Account account, @Param(mo15080id = 4) boolean z, @Param(mo15080id = 5) boolean z2, @Param(mo15080id = 6) boolean z3, @Param(mo15080id = 7) String str, @Param(mo15080id = 8) String str2, @Param(mo15080id = 9) ArrayList<GoogleSignInOptionsExtensionParcelable> arrayList2) {
