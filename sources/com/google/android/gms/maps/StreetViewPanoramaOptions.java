...
public final class StreetViewPanoramaOptions extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @Field(getter = "getPanoramaId", mo15077id = 3)
    private String panoId;
    @Field(getter = "getPosition", mo15077id = 4)
    private LatLng position;
    @Field(getter = "getUseViewLifecycleInFragmentForParcel", mo15077id = 10, type = "byte")
    private Boolean zzak;
    @Field(getter = "getZoomGesturesEnabledForParcel", mo15077id = 7, type = "byte")
    private Boolean zzap = Boolean.valueOf(true);
    @Field(getter = "getStreetViewPanoramaCamera", mo15077id = 2)
    private StreetViewPanoramaCamera zzbx;
    @Field(getter = "getRadius", mo15077id = 5)
    private Integer zzby;
    @Field(getter = "getUserNavigationEnabledForParcel", mo15077id = 6, type = "byte")
    private Boolean zzbz = Boolean.valueOf(true);
    @Field(getter = "getPanningGesturesEnabledForParcel", mo15077id = 8, type = "byte")
    private Boolean zzca = Boolean.valueOf(true);
    @Field(getter = "getStreetNamesEnabledForParcel", mo15077id = 9, type = "byte")
    private Boolean zzcb = Boolean.valueOf(true);
    @Field(getter = "getSource", mo15077id = 11)
    private StreetViewSource zzcc = StreetViewSource.DEFAULT;

    @Constructor
    StreetViewPanoramaOptions(@Param(mo15080id = 2) StreetViewPanoramaCamera streetViewPanoramaCamera, @Param(mo15080id = 3) String str, @Param(mo15080id = 4) LatLng latLng, @Param(mo15080id = 5) Integer num, @Param(mo15080id = 6) byte b, @Param(mo15080id = 7) byte b2, @Param(mo15080id = 8) byte b3, @Param(mo15080id = 9) byte b4, @Param(mo15080id = 10) byte b5, @Param(mo15080id = 11) StreetViewSource streetViewSource) {
