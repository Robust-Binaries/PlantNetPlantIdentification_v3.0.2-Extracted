...
public final class TileOverlayOptions extends AbstractSafeParcelable {
    ...
    @Field(getter = "getZIndex", mo15077id = 4)
    private float zzcs;
    @Field(getter = "isVisible", mo15077id = 3)
    private boolean zzct = true;
    @Field(getter = "getTransparency", mo15077id = 6)
    private float zzda = 0.0f;
    /* access modifiers changed from: private */
    @Field(getter = "getTileProviderDelegate", mo15077id = 2, type = "android.os.IBinder")
    public zzaf zzei;
    private TileProvider zzej;
    @Field(defaultValue = "true", getter = "getFadeIn", mo15077id = 5)
    ...
    @Constructor
    TileOverlayOptions(@Param(mo15080id = 2) IBinder iBinder, @Param(mo15080id = 3) boolean z, @Param(mo15080id = 4) float f, @Param(mo15080id = 5) boolean z2, @Param(mo15080id = 6) float f2) {
        zzs zzs;
