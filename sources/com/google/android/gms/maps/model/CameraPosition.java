...
public final class CameraPosition extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @Constructor
    public CameraPosition(@Param(mo15080id = 2) LatLng latLng, @Param(mo15080id = 3) float f, @Param(mo15080id = 4) float f2, @Param(mo15080id = 5) float f3) {
    ...
    public final String toString() {
        return Objects.toStringHelper(this).add(TouchesHelper.TARGET_KEY, this.target).add("zoom", Float.valueOf(this.zoom)).add("tilt", Float.valueOf(this.tilt)).add("bearing", Float.valueOf(this.bearing)).toString();
    }
