...
public final class PolylineOptions extends AbstractSafeParcelable {
    ...
    @Field(getter = "getColor", mo15077id = 4)
    private int color;
    @Field(getter = "getWidth", mo15077id = 3)
    private float width;
    @Field(getter = "getZIndex", mo15077id = 5)
    private float zzcs;
    @Field(getter = "isVisible", mo15077id = 6)
    private boolean zzct;
    @Field(getter = "isClickable", mo15077id = 8)
    private boolean zzcu;
    @Field(getter = "getPoints", mo15077id = 2)
    private final List<LatLng> zzdx;
    @Field(getter = "isGeodesic", mo15077id = 7)
    private boolean zzdz;
    @Field(getter = "getStartCap", mo15077id = 9)
    @NonNull
    private Cap zzec;
    @Field(getter = "getEndCap", mo15077id = 10)
    @NonNull
    private Cap zzed;
    @Field(getter = "getJointType", mo15077id = 11)
    private int zzee;
    @Nullable
    @Field(getter = "getPattern", mo15077id = 12)
    ...
    @Constructor
    PolylineOptions(@Param(mo15080id = 2) List list, @Param(mo15080id = 3) float f, @Param(mo15080id = 4) int i, @Param(mo15080id = 5) float f2, @Param(mo15080id = 6) boolean z, @Param(mo15080id = 7) boolean z2, @Param(mo15080id = 8) boolean z3, @Nullable @Param(mo15080id = 9) Cap cap, @Nullable @Param(mo15080id = 10) Cap cap2, @Param(mo15080id = 11) int i2, @Nullable @Param(mo15080id = 12) List<PatternItem> list2) {
        this.width = 10.0f;
        this.color = ViewCompat.MEASURED_STATE_MASK;
        this.zzcs = 0.0f;
        this.zzct = true;
