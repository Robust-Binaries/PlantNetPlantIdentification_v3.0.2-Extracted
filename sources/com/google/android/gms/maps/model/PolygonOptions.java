...
public final class PolygonOptions extends AbstractSafeParcelable {
    ...
    @Field(getter = "isClickable", mo15077id = 10)
    private boolean zzcu;
    @Nullable
    @Field(getter = "getStrokePattern", mo15077id = 12)
    private List<PatternItem> zzcv;
    @Field(getter = "getPoints", mo15077id = 2)
    private final List<LatLng> zzdx;
    @Field(getter = "getHolesForParcel", mo15077id = 3, type = "java.util.List")
    private final List<List<LatLng>> zzdy;
    @Field(getter = "isGeodesic", mo15077id = 9)
    private boolean zzdz;
    @Field(getter = "getStrokeJointType", mo15077id = 11)
    private int zzea;
    ...
    @Constructor
    PolygonOptions(@Param(mo15080id = 2) List<LatLng> list, @Param(mo15080id = 3) List list2, @Param(mo15080id = 4) float f, @Param(mo15080id = 5) int i, @Param(mo15080id = 6) int i2, @Param(mo15080id = 7) float f2, @Param(mo15080id = 8) boolean z, @Param(mo15080id = 9) boolean z2, @Param(mo15080id = 10) boolean z3, @Param(mo15080id = 11) int i3, @Nullable @Param(mo15080id = 12) List<PatternItem> list3) {
        this.zzcr = 10.0f;
        this.strokeColor = ViewCompat.MEASURED_STATE_MASK;
        this.fillColor = 0;
        this.zzcs = 0.0f;
