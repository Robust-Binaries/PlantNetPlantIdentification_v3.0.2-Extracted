...
public final class GroundOverlayOptions extends AbstractSafeParcelable {
    ...
    @Field(getter = "getBearing", mo15077id = 7)
    private float bearing;
    @Field(getter = "getHeight", mo15077id = 5)
    private float height;
    @Field(getter = "getWidth", mo15077id = 4)
    private float width;
    @Field(getter = "getZIndex", mo15077id = 8)
    private float zzcs;
    @Field(getter = "isVisible", mo15077id = 9)
    private boolean zzct = true;
    @Field(getter = "isClickable", mo15077id = 13)
    private boolean zzcu = false;
    @Field(getter = "getWrappedImageDescriptorImplBinder", mo15077id = 2, type = "android.os.IBinder")
    @NonNull
    private BitmapDescriptor zzcx;
    @Field(getter = "getLocation", mo15077id = 3)
    private LatLng zzcy;
    @Field(getter = "getBounds", mo15077id = 6)
    private LatLngBounds zzcz;
    @Field(getter = "getTransparency", mo15077id = 10)
    private float zzda = 0.0f;
    @Field(getter = "getAnchorU", mo15077id = 11)
    private float zzdb = 0.5f;
    @Field(getter = "getAnchorV", mo15077id = 12)
    private float zzdc = 0.5f;

    @Constructor
    GroundOverlayOptions(@Param(mo15080id = 2) IBinder iBinder, @Param(mo15080id = 3) LatLng latLng, @Param(mo15080id = 4) float f, @Param(mo15080id = 5) float f2, @Param(mo15080id = 6) LatLngBounds latLngBounds, @Param(mo15080id = 7) float f3, @Param(mo15080id = 8) float f4, @Param(mo15080id = 9) boolean z, @Param(mo15080id = 10) float f5, @Param(mo15080id = 11) float f6, @Param(mo15080id = 12) float f7, @Param(mo15080id = 13) boolean z2) {
