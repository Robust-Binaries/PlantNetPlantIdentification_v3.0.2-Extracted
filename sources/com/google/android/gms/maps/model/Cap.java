...
public class Cap extends AbstractSafeParcelable {
    ...
    @Nullable
    @Field(getter = "getWrappedBitmapDescriptorImplBinder", mo15077id = 3, type = "android.os.IBinder")
    private final BitmapDescriptor bitmapDescriptor;
    @Field(getter = "getType", mo15077id = 2)
    private final int type;
    @Nullable
    @Field(getter = "getBitmapRefWidth", mo15077id = 4)
    ...
    @Constructor
    Cap(@Param(mo15080id = 2) int i, @Nullable @Param(mo15080id = 3) IBinder iBinder, @Nullable @Param(mo15080id = 4) Float f) {
