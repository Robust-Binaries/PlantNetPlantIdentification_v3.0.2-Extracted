...
public class VectorIconsModule extends ReactContextBaseJavaModule {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:36:0x016b A[SYNTHETIC, Splitter:B:36:0x016b] */
    /* JADX WARNING: Removed duplicated region for block: B:43:? A[RETURN, SYNTHETIC] */
    /* JADX WARNING: Unknown top exception splitter block from list: {B:22:0x0141=Splitter:B:22:0x0141, B:28:0x0153=Splitter:B:28:0x0153} */
    ...
    public void getImageForFont(java.lang.String r9, java.lang.String r10, java.lang.Integer r11, java.lang.Integer r12, com.facebook.react.bridge.Callback r13) {
        ...
        L_0x00cf:
            ...
            java.io.FileOutputStream r9 = new java.io.FileOutputStream     // Catch:{ FileNotFoundException -> 0x0152, IOException -> 0x0140 }
            r9.<init>(r3)     // Catch:{ FileNotFoundException -> 0x0152, IOException -> 0x0140 }
            android.graphics.Bitmap$CompressFormat r10 = android.graphics.Bitmap.CompressFormat.PNG     // Catch:{ FileNotFoundException -> 0x013a, IOException -> 0x0136, all -> 0x0132 }
            r11 = 100
            r12.compress(r10, r11, r9)     // Catch:{ FileNotFoundException -> 0x013a, IOException -> 0x0136, all -> 0x0132 }
            r9.flush()     // Catch:{ FileNotFoundException -> 0x013a, IOException -> 0x0136, all -> 0x0132 }
            r9.close()     // Catch:{ FileNotFoundException -> 0x013a, IOException -> 0x0136, all -> 0x0132 }
            java.lang.Object[] r9 = new java.lang.Object[r4]     // Catch:{ FileNotFoundException -> 0x0152, IOException -> 0x0140 }
            r9[r7] = r5     // Catch:{ FileNotFoundException -> 0x0152, IOException -> 0x0140 }
            r9[r6] = r1     // Catch:{ FileNotFoundException -> 0x0152, IOException -> 0x0140 }
            r13.invoke(r9)     // Catch:{ FileNotFoundException -> 0x0152, IOException -> 0x0140 }
            goto L_0x0168
        L_0x0132:
            r10 = move-exception
            r5 = r9
        ...
        L_0x0140:
            r9 = move-exception
        L_0x0141:
            java.lang.Object[] r10 = new java.lang.Object[r6]     // Catch:{ all -> 0x013e }
            java.lang.String r9 = r9.getMessage()     // Catch:{ all -> 0x013e }
            r10[r7] = r9     // Catch:{ all -> 0x013e }
            r13.invoke(r10)     // Catch:{ all -> 0x013e }
