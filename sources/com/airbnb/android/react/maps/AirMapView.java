...
public class AirMapView extends MapView implements InfoWindowAdapter, OnMarkerDragListener, OnMapReadyCallback, OnPoiClickListener, OnIndoorStateChangeListener {
    ...
    public void onPoiClick(PointOfInterest pointOfInterest) {
        ...
        makeClickEventData.putString(ConditionalUserProperty.NAME, pointOfInterest.name);
                ...
                if (kmlContainer != null) {
                    if (kmlContainer.getContainers() != null) {
                        ...
                        for (KmlPlacemark kmlPlacemark : kmlContainer.getPlacemarks()) {
                            ...
                            String str2 = "";
                            String str3 = "";
                            if (kmlPlacemark.hasProperty(ConditionalUserProperty.NAME)) {
                                str2 = kmlPlacemark.getProperty(ConditionalUserProperty.NAME);
                            }
                            if (kmlPlacemark.hasProperty("description")) {
                                str3 = kmlPlacemark.getProperty("description");
                            }
                            markerOptions.position(latLng);
                            markerOptions.title(str2);
                            markerOptions.snippet(str3);
                            AirMapMarker airMapMarker = new AirMapMarker(this.context, markerOptions);
    ...
    public void onIndoorBuildingFocused() {
        ...
        if (focusedBuilding != null) {
            ...
            for (IndoorLevel indoorLevel : levels) {
                ...
                createMap.putInt(Param.INDEX, i);
                createMap.putString(ConditionalUserProperty.NAME, indoorLevel.getName());
    ...
    public void onIndoorLevelActivated(IndoorBuilding indoorBuilding) {
        if (indoorBuilding != null) {
            ...
            if (activeLevelIndex >= 0 && activeLevelIndex < indoorBuilding.getLevels().size()) {
                ...
                createMap2.putString(ConditionalUserProperty.NAME, indoorLevel.getName());
