...
public class AirMapManager extends ViewGroupManager<AirMapView> {
    ...
    private final Map<String, Integer> MAP_TYPES = MapBuilder.m125of("standard", Integer.valueOf(1), "satellite", Integer.valueOf(2), "hybrid", Integer.valueOf(4), "terrain", Integer.valueOf(3), ViewProps.NONE, Integer.valueOf(0));
    ...
    public void setMapPadding(AirMapView airMapView, @Nullable ReadableMap readableMap) {
        ...
        if (readableMap != null) {
            if (readableMap.hasKey(ViewProps.LEFT)) {
                double d2 = readableMap.getDouble(ViewProps.LEFT);
                Double.isNaN(d);
                i3 = (int) (d2 * d);
            } else {
                i3 = 0;
            ...
            if (readableMap.hasKey(ViewProps.TOP)) {
                double d3 = readableMap.getDouble(ViewProps.TOP);
                Double.isNaN(d);
                i2 = (int) (d3 * d);
            } else {
                i2 = 0;
            ...
            if (readableMap.hasKey(ViewProps.RIGHT)) {
                double d4 = readableMap.getDouble(ViewProps.RIGHT);
                Double.isNaN(d);
                i = (int) (d4 * d);
            } else {
                i = 0;
            ...
            if (readableMap.hasKey(ViewProps.BOTTOM)) {
                double d5 = readableMap.getDouble(ViewProps.BOTTOM);
                Double.isNaN(d);
                i4 = (int) (d5 * d);
            }
        } else {
    ...
    public Map getExportedCustomDirectEventTypeConstants() {
        Map of = MapBuilder.m127of("onMapReady", MapBuilder.m121of("registrationName", "onMapReady"), "onPress", MapBuilder.m121of("registrationName", "onPress"), "onLongPress", MapBuilder.m121of("registrationName", "onLongPress"), "onMarkerPress", MapBuilder.m121of("registrationName", "onMarkerPress"), "onMarkerSelect", MapBuilder.m121of("registrationName", "onMarkerSelect"), "onMarkerDeselect", MapBuilder.m121of("registrationName", "onMarkerDeselect"), "onCalloutPress", MapBuilder.m121of("registrationName", "onCalloutPress"));
        of.putAll(MapBuilder.m127of("onUserLocationChange", MapBuilder.m121of("registrationName", "onUserLocationChange"), "onMarkerDragStart", MapBuilder.m121of("registrationName", "onMarkerDragStart"), "onMarkerDrag", MapBuilder.m121of("registrationName", "onMarkerDrag"), "onMarkerDragEnd", MapBuilder.m121of("registrationName", "onMarkerDragEnd"), "onPanDrag", MapBuilder.m121of("registrationName", "onPanDrag"), "onKmlReady", MapBuilder.m121of("registrationName", "onKmlReady"), "onPoiClick", MapBuilder.m121of("registrationName", "onPoiClick")));
        of.putAll(MapBuilder.m122of("onIndoorLevelActivated", MapBuilder.m121of("registrationName", "onIndoorLevelActivated"), "onIndoorBuildingFocused", MapBuilder.m121of("registrationName", "onIndoorBuildingFocused")));
        return of;
    }
    ...
    public Map<String, Integer> getCommandsMap() {
        ...
        CreateMap.putAll(MapBuilder.m122of("setMapBoundaries", Integer.valueOf(8), "setIndoorActiveLevelIndex", Integer.valueOf(10)));
        return CreateMap;
    }
