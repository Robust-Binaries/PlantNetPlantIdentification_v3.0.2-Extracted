...
public final class StreamAllocation {
    ...
    private okhttp3.internal.connection.RealConnection findConnection(int r19, int r20, int r21, int r22, boolean r23) throws java.io.IOException {
        /*
            ...
            monitor-enter(r2)
            boolean r0 = r1.released     // Catch:{ all -> 0x013d }
            if (r0 != 0) goto L_0x0135
            okhttp3.internal.http.HttpCodec r0 = r1.codec     // Catch:{ all -> 0x013d }
            if (r0 != 0) goto L_0x012d
            boolean r0 = r1.canceled     // Catch:{ all -> 0x013d }
            if (r0 != 0) goto L_0x0125
            okhttp3.internal.connection.RealConnection r0 = r1.connection     // Catch:{ all -> 0x013d }
            java.net.Socket r3 = r18.releaseIfNoNewStreams()     // Catch:{ all -> 0x013d }
            okhttp3.internal.connection.RealConnection r4 = r1.connection     // Catch:{ all -> 0x013d }
            r5 = 0
        ...
        L_0x0020:
            ...
            r0 = r5
        L_0x0022:
            boolean r6 = r1.reportedAcquired     // Catch:{ all -> 0x013d }
        ...
        L_0x0027:
            ...
            okhttp3.internal.Internal r8 = okhttp3.internal.Internal.instance     // Catch:{ all -> 0x013d }
            okhttp3.ConnectionPool r9 = r1.connectionPool     // Catch:{ all -> 0x013d }
            okhttp3.Address r10 = r1.address     // Catch:{ all -> 0x013d }
            r8.get(r9, r10, r1, r5)     // Catch:{ all -> 0x013d }
            okhttp3.internal.connection.RealConnection r8 = r1.connection     // Catch:{ all -> 0x013d }
            ...
            goto L_0x0047
        L_0x003e:
            okhttp3.Route r8 = r1.route     // Catch:{ all -> 0x013d }
            r9 = r8
            r8 = r0
            r0 = 0
            goto L_0x0047
        ...
        L_0x0077:
            ...
            monitor-enter(r3)
            boolean r4 = r1.canceled     // Catch:{ all -> 0x0122 }
            if (r4 != 0) goto L_0x011a
            if (r2 == 0) goto L_0x00a9
            okhttp3.internal.connection.RouteSelector$Selection r2 = r1.routeSelection     // Catch:{ all -> 0x0122 }
            java.util.List r2 = r2.getAll()     // Catch:{ all -> 0x0122 }
            int r4 = r2.size()     // Catch:{ all -> 0x0122 }
            r10 = 0
        L_0x008b:
            if (r10 >= r4) goto L_0x00a9
            java.lang.Object r11 = r2.get(r10)     // Catch:{ all -> 0x0122 }
            okhttp3.Route r11 = (okhttp3.Route) r11     // Catch:{ all -> 0x0122 }
            okhttp3.internal.Internal r12 = okhttp3.internal.Internal.instance     // Catch:{ all -> 0x0122 }
            okhttp3.ConnectionPool r13 = r1.connectionPool     // Catch:{ all -> 0x0122 }
            okhttp3.Address r14 = r1.address     // Catch:{ all -> 0x0122 }
            r12.get(r13, r14, r1, r11)     // Catch:{ all -> 0x0122 }
            okhttp3.internal.connection.RealConnection r12 = r1.connection     // Catch:{ all -> 0x0122 }
            if (r12 == 0) goto L_0x00a6
            okhttp3.internal.connection.RealConnection r8 = r1.connection     // Catch:{ all -> 0x0122 }
            r1.route = r11     // Catch:{ all -> 0x0122 }
            r0 = 1
            goto L_0x00a9
        L_0x00a6:
            int r10 = r10 + 1
        ...
        L_0x00a9:
            ...
            okhttp3.internal.connection.RouteSelector$Selection r2 = r1.routeSelection     // Catch:{ all -> 0x0122 }
            okhttp3.Route r9 = r2.next()     // Catch:{ all -> 0x0122 }
        L_0x00b3:
            r1.route = r9     // Catch:{ all -> 0x0122 }
            r1.refusedStreamCount = r7     // Catch:{ all -> 0x0122 }
            okhttp3.internal.connection.RealConnection r8 = new okhttp3.internal.connection.RealConnection     // Catch:{ all -> 0x0122 }
            okhttp3.ConnectionPool r2 = r1.connectionPool     // Catch:{ all -> 0x0122 }
            r8.<init>(r2, r9)     // Catch:{ all -> 0x0122 }
            r1.acquire(r8, r7)     // Catch:{ all -> 0x0122 }
        L_0x00c1:
        ...
        L_0x00cc:
            ...
            okhttp3.ConnectionPool r2 = r1.connectionPool
            monitor-enter(r2)
            r1.reportedAcquired = r6     // Catch:{ all -> 0x0117 }
            okhttp3.internal.Internal r0 = okhttp3.internal.Internal.instance     // Catch:{ all -> 0x0117 }
            okhttp3.ConnectionPool r3 = r1.connectionPool     // Catch:{ all -> 0x0117 }
            r0.put(r3, r8)     // Catch:{ all -> 0x0117 }
            boolean r0 = r8.isMultiplexed()     // Catch:{ all -> 0x0117 }
            if (r0 == 0) goto L_0x010b
            okhttp3.internal.Internal r0 = okhttp3.internal.Internal.instance     // Catch:{ all -> 0x0117 }
            okhttp3.ConnectionPool r3 = r1.connectionPool     // Catch:{ all -> 0x0117 }
            okhttp3.Address r4 = r1.address     // Catch:{ all -> 0x0117 }
            java.net.Socket r5 = r0.deduplicate(r3, r4, r1)     // Catch:{ all -> 0x0117 }
            okhttp3.internal.connection.RealConnection r8 = r1.connection     // Catch:{ all -> 0x0117 }
        L_0x010b:
        ...
        L_0x012d:
            java.lang.IllegalStateException r0 = new java.lang.IllegalStateException     // Catch:{ all -> 0x013d }
