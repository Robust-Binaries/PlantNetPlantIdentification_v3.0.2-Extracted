...
import okhttp3.internal.p012ws.RealWebSocket.Streams;
...
public final class RealConnection extends Listener implements Connection {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:64:0x0145 A[EDGE_INSN: B:64:0x0145->B:56:0x0145 ?: BREAK  , SYNTHETIC] */
    ...
    public void connect(int r17, int r18, int r19, int r20, boolean r21, okhttp3.Call r22, okhttp3.EventListener r23) {
        ...
        L_0x0086:
            ...
            r12 = r11
        L_0x0088:
            okhttp3.Route r0 = r7.route     // Catch:{ IOException -> 0x00fb }
            boolean r0 = r0.requiresTunnel()     // Catch:{ IOException -> 0x00fb }
            ...
            r5 = r22
            r6 = r23
            r1.connectTunnel(r2, r3, r4, r5, r6)     // Catch:{ IOException -> 0x00fb }
            java.net.Socket r0 = r7.rawSocket     // Catch:{ IOException -> 0x00fb }
        ...
        L_0x00ab:
            r13 = r17
            r14 = r18
            r7.connectSocket(r13, r14, r8, r9)     // Catch:{ IOException -> 0x00f9 }
            r15 = r20
        L_0x00b4:
            r7.establishProtocol(r10, r15, r8, r9)     // Catch:{ IOException -> 0x00f7 }
            okhttp3.Route r0 = r7.route     // Catch:{ IOException -> 0x00f7 }
            java.net.InetSocketAddress r0 = r0.socketAddress()     // Catch:{ IOException -> 0x00f7 }
            okhttp3.Route r1 = r7.route     // Catch:{ IOException -> 0x00f7 }
            java.net.Proxy r1 = r1.proxy()     // Catch:{ IOException -> 0x00f7 }
            okhttp3.Protocol r2 = r7.protocol     // Catch:{ IOException -> 0x00f7 }
            r9.connectEnd(r8, r0, r1, r2)     // Catch:{ IOException -> 0x00f7 }
        L_0x00c8:
            okhttp3.Route r0 = r7.route
        ...
        L_0x00e2:
            ...
            monitor-enter(r1)
            okhttp3.internal.http2.Http2Connection r0 = r7.http2Connection     // Catch:{ all -> 0x00f3 }
            int r0 = r0.maxConcurrentStreams()     // Catch:{ all -> 0x00f3 }
            r7.allocationLimit = r0     // Catch:{ all -> 0x00f3 }
    ...
    private Request createTunnel(int i, int i2, Request request, HttpUrl httpUrl) throws IOException {
        ...
        while (true) {
            ...
            C1512Response build = http1Codec.readResponseHeaders(false).request(request).build();
    ...
    private Request createTunnelRequest() throws IOException {
        ...
        Request authenticate = this.route.address().proxyAuthenticator().authenticate(this.route, new C1512Response.Builder().request(build).protocol(Protocol.HTTP_1_1).code(407).message("Preemptive Authenticate").body(Util.EMPTY_RESPONSE).sentRequestAtMillis(-1).receivedResponseAtMillis(-1).header("Proxy-Authenticate", "OkHttp-Preemptive").build());
    ...
    public Streams newWebSocketStreams(StreamAllocation streamAllocation) {
        ...
        C15221 r0 = new Streams(true, this.source, this.sink) {
