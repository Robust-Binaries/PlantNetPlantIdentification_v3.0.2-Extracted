...
public final class CacheStrategy {
    @Nullable
    public final C1512Response cacheResponse;
    @Nullable
    ...
    public static class Factory {
        ...
        public Factory(long j, Request request2, C1512Response response) {
            this.nowMillis = j;
    ...
    CacheStrategy(Request request, C1512Response response) {
    ...
    public static boolean isCacheable(okhttp3.C1512Response r3, okhttp3.Request r4) {
        /*
            int r0 = r3.code()
            r1 = 0
            switch(r0) {
