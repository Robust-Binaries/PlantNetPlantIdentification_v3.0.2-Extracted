...
final class DistinguishedNameParser {
    ...
    /* renamed from: dn */
    private final String f128dn;
    private int end;
    private final int length = this.f128dn.length();
    private int pos;

    DistinguishedNameParser(X500Principal x500Principal) {
        this.f128dn = x500Principal.getName("RFC2253");
    }
    ...
    public String findMostSpecific(String str) {
        ...
        this.end = 0;
        this.cur = 0;
        this.chars = this.f128dn.toCharArray();
