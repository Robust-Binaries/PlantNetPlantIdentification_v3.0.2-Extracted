...
public final class RealWebSocket implements WebSocket, FrameCallback {
    ...
    public RealWebSocket(Request request, WebSocketListener webSocketListener, Random random2, long j) {
        if ("GET".equals(request.method())) {
            ...
            this.key = ByteString.m192of(bArr).base64();
    ...
    public void connect(OkHttpClient okHttpClient) {
        ...
        this.call.enqueue(new Callback() {
            public void onResponse(Call call, C1512Response response) {
                try {
    ...
    public void checkResponse(C1512Response response) throws ProtocolException {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:24:0x0059, code lost:
        if ((r5 instanceof okhttp3.internal.p012ws.RealWebSocket.Message) == false) goto L_0x0087;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:36:0x0089, code lost:
        if ((r5 instanceof okhttp3.internal.p012ws.RealWebSocket.Close) == false) goto L_0x00a0;
     */
    ...
    public boolean writeOneFrame() throws java.io.IOException {
        ...
        L_0x0008:
            ...
            boolean r6 = r5 instanceof okhttp3.internal.p012ws.RealWebSocket.Close     // Catch:{ all -> 0x00ab }
        ...
        L_0x0031:
            ...
            r8 = r5
            okhttp3.internal.ws.RealWebSocket$Close r8 = (okhttp3.internal.p012ws.RealWebSocket.Close) r8     // Catch:{ all -> 0x00ab }
        ...
        L_0x0050:
            ...
            goto L_0x009b
        L_0x0057:
            boolean r2 = r5 instanceof okhttp3.internal.p012ws.RealWebSocket.Message     // Catch:{ all -> 0x00a6 }
            if (r2 == 0) goto L_0x0087
            r1 = r5
            okhttp3.internal.ws.RealWebSocket$Message r1 = (okhttp3.internal.p012ws.RealWebSocket.Message) r1     // Catch:{ all -> 0x00a6 }
            okio.ByteString r1 = r1.data     // Catch:{ all -> 0x00a6 }
            okhttp3.internal.ws.RealWebSocket$Message r5 = (okhttp3.internal.p012ws.RealWebSocket.Message) r5     // Catch:{ all -> 0x00a6 }
        ...
        L_0x0087:
            boolean r2 = r5 instanceof okhttp3.internal.p012ws.RealWebSocket.Close     // Catch:{ all -> 0x00a6 }
            if (r2 == 0) goto L_0x00a0
            okhttp3.internal.ws.RealWebSocket$Close r5 = (okhttp3.internal.p012ws.RealWebSocket.Close) r5     // Catch:{ all -> 0x00a6 }
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public void failWebSocket(java.lang.Exception r4, @javax.annotation.Nullable okhttp3.C1512Response r5) {
        /*
            r3 = this;
            monitor-enter(r3)
