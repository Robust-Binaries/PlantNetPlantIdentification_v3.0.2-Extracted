...
final class RealCall implements Call {
    ...
    public C1512Response execute() throws IOException {
        synchronized (this) {
            if (!this.executed) {
                this.executed = true;
            } else {
        ...
        try {
            ...
            C1512Response responseWithInterceptorChain = getResponseWithInterceptorChain();
    ...
    /* access modifiers changed from: 0000 */
    public C1512Response getResponseWithInterceptorChain() throws IOException {
