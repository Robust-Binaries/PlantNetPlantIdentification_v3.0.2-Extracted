            ...
            if (slashCount >= 2 || httpUrl2 == null || !httpUrl2.scheme.equals(this.scheme)) {
                        ...
                        switch (charAt) {
                            ...
                            case '@':
                                if (!z) {
                                    ...
                                    if (i3 != i) {
                                        this.encodedPassword = HttpUrl.canonicalize(str, i3 + 1, i, " \"':;<=>@[]^`{}|/\\?#", true, false, false, true, null);
                                        z = true;
                                    }
                                    z2 = true;
                                } else {
                ...
                if (i5 < i4) {
                    ...
                    if (this.port == -1) {
                        ...
                        sb4.append(str2.substring(i5, i4));
                ...
                if (this.host != null) {
                    ...
                    sb5.append(str2.substring(i2, portColonOffset));
