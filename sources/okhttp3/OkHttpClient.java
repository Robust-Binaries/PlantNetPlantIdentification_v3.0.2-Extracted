...
public class OkHttpClient implements Cloneable, Factory, WebSocket.Factory {
    ...
    public static final class Builder {
        ...
        public Builder() {
            ...
            this.callTimeout = 0;
            this.connectTimeout = IPTCConstants.IMAGE_RESOURCE_BLOCK_PRINT_FLAGS_INFO;
            this.readTimeout = IPTCConstants.IMAGE_RESOURCE_BLOCK_PRINT_FLAGS_INFO;
            this.writeTimeout = IPTCConstants.IMAGE_RESOURCE_BLOCK_PRINT_FLAGS_INFO;
            this.pingInterval = 0;
        }
    ...
    static {
        Internal.instance = new Internal() {
            ...
            public int code(okhttp3.C1512Response.Builder builder) {
                return builder.code;
            }
