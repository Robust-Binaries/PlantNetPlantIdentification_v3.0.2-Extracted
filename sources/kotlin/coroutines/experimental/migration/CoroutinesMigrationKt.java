...
public final class CoroutinesMigrationKt {
    ...
    public static final kotlin.coroutines.experimental.CoroutineContext toExperimentalCoroutineContext(@org.jetbrains.annotations.NotNull kotlin.coroutines.CoroutineContext r3) {
        /*
    ...
    @kotlin.SinceKotlin(version = "1.3")
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static final kotlin.coroutines.CoroutineContext toCoroutineContext(@org.jetbrains.annotations.NotNull kotlin.coroutines.experimental.CoroutineContext r3) {
        /*
            java.lang.String r0 = "receiver$0"
            kotlin.jvm.internal.Intrinsics.checkParameterIsNotNull(r3, r0)
    ...
    @NotNull
    @SinceKotlin(version = "1.3")
    public static final ContinuationInterceptor toExperimentalContinuationInterceptor(@NotNull kotlin.coroutines.ContinuationInterceptor continuationInterceptor) {
    ...
    @NotNull
    @SinceKotlin(version = "1.3")
    public static final kotlin.coroutines.ContinuationInterceptor toContinuationInterceptor(@NotNull ContinuationInterceptor continuationInterceptor) {
        Intrinsics.checkParameterIsNotNull(continuationInterceptor, "receiver$0");
