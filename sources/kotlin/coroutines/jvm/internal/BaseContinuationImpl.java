        ...
        while (true) {
            ...
            try {
                ...
                if (invokeSuspend != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                    ...
                    obj = Result.m198constructorimpl(invokeSuspend);
                ...
                obj = Result.m198constructorimpl(ResultKt.createFailure(th));
            }
        }
    }
