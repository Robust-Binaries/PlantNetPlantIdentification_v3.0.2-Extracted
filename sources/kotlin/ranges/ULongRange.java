...
public final class ULongRange extends ULongProgression implements ClosedRange<ULong> {
    ...
    @Metadata(mo20294bv = {1, 0, 3}, mo20295d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u0011\u0010\u0003\u001a\u00020\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0005\u0010\u0006¨\u0006\u0007"}, mo20296d2 = {"Lkotlin/ranges/ULongRange$Companion;", "", "()V", "EMPTY", "Lkotlin/ranges/ULongRange;", "getEMPTY", "()Lkotlin/ranges/ULongRange;", "kotlin-stdlib"}, mo20297k = 1, mo20298mv = {1, 1, 13})
    /* compiled from: ULongRange.kt */
    ...
    public /* bridge */ /* synthetic */ boolean contains(Comparable comparable) {
        return m549containsVKZWuLQ(((ULong) comparable).m389unboximpl());
    }

    @NotNull
    public ULong getStart() {
        return ULong.m342boximpl(getFirst());
    }

    @NotNull
    public ULong getEndInclusive() {
        return ULong.m342boximpl(getLast());
    }

    /* renamed from: contains-VKZWuLQ reason: not valid java name */
    public boolean m549containsVKZWuLQ(long j) {
    ...
    public int hashCode() {
        ...
        return (((int) ULong.m348constructorimpl(getFirst() ^ ULong.m348constructorimpl(getFirst() >>> 32))) * 31) + ((int) ULong.m348constructorimpl(getLast() ^ ULong.m348constructorimpl(getLast() >>> 32)));
    }

    @NotNull
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append(ULong.m342boximpl(getFirst()));
        sb.append("..");
        sb.append(ULong.m342boximpl(getLast()));
        return sb.toString();
    }
