...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    @Metadata(mo20294bv = {1, 0, 3}, mo20295d1 = {"\u0000\"\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\t\n\u0002\b\u0003\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J(\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\u00062\u0006\u0010\b\u001a\u00020\tø\u0001\u0000¢\u0006\u0004\b\n\u0010\u000b\u0002\u0004\n\u0002\b\u0019¨\u0006\f"}, mo20296d2 = {"Lkotlin/ranges/ULongProgression$Companion;", "", "()V", "fromClosedRange", "Lkotlin/ranges/ULongProgression;", "rangeStart", "Lkotlin/ULong;", "rangeEnd", "step", "", "fromClosedRange-7ftBX0g", "(JJJ)Lkotlin/ranges/ULongProgression;", "kotlin-stdlib"}, mo20297k = 1, mo20298mv = {1, 1, 13})
    /* compiled from: ULongRange.kt */
    public static final class Companion {
        ...
        public final ULongProgression m548fromClosedRange7ftBX0g(long j, long j2, long j3) {
    ...
    private ULongProgression(long j, long j2, long j3) {
        if (j3 == 0) {
            ...
            this.first = j;
            this.last = UProgressionUtilKt.m535getProgressionLastElement7ftBX0g(j, j2, j3);
            this.step = j3;
        } else {
    ...
    public int hashCode() {
        ...
        long j = this.first;
        int r0 = ((int) ULong.m348constructorimpl(j ^ ULong.m348constructorimpl(j >>> 32))) * 31;
        long j2 = this.last;
        int r02 = (r0 + ((int) ULong.m348constructorimpl(j2 ^ ULong.m348constructorimpl(j2 >>> 32)))) * 31;
        long j3 = this.step;
    ...
    public String toString() {
        ...
        if (this.step > 0) {
            ...
            sb.append(ULong.m342boximpl(this.first));
            sb.append("..");
            sb.append(ULong.m342boximpl(this.last));
            sb.append(" step ");
            j = this.step;
        } else {
            sb = new StringBuilder();
