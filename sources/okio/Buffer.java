...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable, ByteChannel {
    private static final byte[] DIGITS = {48, PNMConstants.PBM_TEXT_CODE, PNMConstants.PGM_TEXT_CODE, PNMConstants.PPM_TEXT_CODE, PNMConstants.PBM_RAW_CODE, PNMConstants.PGM_RAW_CODE, PNMConstants.PPM_RAW_CODE, 55, 56, 57, 97, 98, 99, 100, 101, 102};
            ...
            while (true) {
                ...
                if (i11 < 0) {
                    ...
                    while (true) {
                        i2 = i6 + 1;
                        int i15 = i12 + 1;
                        if ((bArr2[i6] & UByte.MAX_VALUE) != iArr[i12]) {
                            return i8;
                        }
                        boolean z2 = i15 == i14;
                        if (i2 == i7) {
                    ...
                    int i18 = i6 + 1;
                    byte b = bArr2[i6] & UByte.MAX_VALUE;
                    int i19 = i12 + i11;
                    while (i12 != i19) {
                        if (b == iArr[i12]) {
                            i = iArr[i12 + i11];
        ...
        if (str == null) {
            ...
            while (i < i2) {
                ...
                if (charAt < 128) {
                    ...
                    writeByte((charAt >> 12) | JpegConstants.JPEG_APP0);
                    ...
                    if (charAt > 56319 || c < 56320 || c > 57343) {
                        ...
                        int i8 = (((charAt & 10239) << 10) | (9215 & c)) + CharCompanionObject.MIN_VALUE;
                        writeByte((i8 >> 18) | 240);
    ...
    public Buffer writeUtf8CodePoint(int i) {
        if (i < 128) {
            ...
            if (i < 55296 || i > 57343) {
                writeByte((i >> 12) | JpegConstants.JPEG_APP0);
    ...
    private ByteString digest(String str) {
        try {
            ...
            return ByteString.m192of(instance.digest());
    ...
    private ByteString hmac(String str, ByteString byteString) {
        try {
            ...
            return ByteString.m192of(instance.doFinal());
        } catch (NoSuchAlgorithmException unused) {
            throw new AssertionError();
