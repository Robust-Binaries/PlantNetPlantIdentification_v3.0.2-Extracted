...
final class Base64 {
    private static final byte[] MAP = {65, 66, 67, 68, 69, 70, 71, 72, 73, 74, 75, 76, 77, 78, 79, PNMConstants.PNM_PREFIX_BYTE, 81, 82, 83, 84, 85, 86, 87, 88, 89, 90, 97, 98, 99, 100, 101, 102, 103, 104, 105, 106, 107, 108, 109, 110, 111, 112, 113, 114, 115, 116, 117, 118, 119, 120, 121, 122, 48, PNMConstants.PBM_TEXT_CODE, PNMConstants.PGM_TEXT_CODE, PNMConstants.PPM_TEXT_CODE, PNMConstants.PBM_RAW_CODE, PNMConstants.PGM_RAW_CODE, PNMConstants.PPM_RAW_CODE, 55, 56, 57, 43, 47};
    private static final byte[] URL_MAP = {65, 66, 67, 68, 69, 70, 71, 72, 73, 74, 75, 76, 77, 78, 79, PNMConstants.PNM_PREFIX_BYTE, 81, 82, 83, 84, 85, 86, 87, 88, 89, 90, 97, 98, 99, 100, 101, 102, 103, 104, 105, 106, 107, 108, 109, 110, 111, 112, 113, 114, 115, 116, 117, 118, 119, 120, 121, 122, 48, PNMConstants.PBM_TEXT_CODE, PNMConstants.PGM_TEXT_CODE, PNMConstants.PPM_TEXT_CODE, PNMConstants.PBM_RAW_CODE, PNMConstants.PGM_RAW_CODE, PNMConstants.PPM_RAW_CODE, 55, 56, 57, 45, 95};
    ...
    private static String encode(byte[] bArr, byte[] bArr2) {
        ...
        switch (bArr.length % 3) {
            ...
            case 2:
                ...
                int i12 = i11 + 1;
                int i13 = length + 1;
                bArr3[i11] = bArr2[((bArr[length] & 3) << 4) | ((bArr[i13] & UByte.MAX_VALUE) >> 4)];
                int i14 = i12 + 1;
